 ...
 * on some devices and a buffer of bytes can generate a CRC using the @ref iec60730_updateCRCWithDataBuffer
 ...
 *
 * The library provides a support function iec60730_updateCRCWithDataBuffer()
