...
#endif // EFR32BG22_DEVICE

#ifdef EFR32FG22_DEVICE
#include "em_device.h"
#define DEVICE_FOUND 1
#ifndef INVAR_BLOCKS_PER_BIST
#define INVAR_BLOCKS_PER_BIST 512
...
#endif // EFR32FG22_DEVICE

#ifdef EFM32PG22_DEVICE
#include "em_device.h"
#define DEVICE_FOUND 1
#ifndef INVAR_BLOCKS_PER_BIST
#define INVAR_BLOCKS_PER_BIST 512
...
#endif // EFM32PG22_DEVICE

#ifdef EFR32MG24_DEVICE
#include "em_device.h"
#define DEVICE_FOUND 1
#ifndef INVAR_BLOCKS_PER_BIST
#define INVAR_BLOCKS_PER_BIST 512
...
typedef enum {
  ...
  iec60730_TestVerify =
      1, ///< Special case used for automated verification testing
  ...
  iec60730_InterruptFail =
      7, ///< Interrupt Plausibility Check detected a failure
  iec60730_ProgrammeCounterFail =
      8,                      ///< Program Counter Check detected a failure
...
extern SI_SEGMENT_VARIABLE(iec60730_SafetyCheck,
                           iec60730_TestFailure_t,
                           SI_SEG_DATA);
...
/// maximum fault time, iec60730_programmeCounterTest() verifies that the
/// value is @ref IEC60730_ALL_COMPLETE_BITS.
extern SI_SEGMENT_VARIABLE(iec60730_programmeCounterCheck,
                           uint16_t,
                           SI_SEG_DATA);
...
extern SI_SEGMENT_VARIABLE(iec60730_systemClockToTestClockFrequency,
                           uint16_t,
                           SI_SEG_DATA);
...
extern SI_SEGMENT_CONST(iec60730_IRQFreqBounds[],
                        iec60730_IRQExecutionBounds_t,
                        SI_SEG_CODE);
/// Defines number of interrupt entries in #iec60730_IRQFreqBounds
///
