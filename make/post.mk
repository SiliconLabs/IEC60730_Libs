...
DEFS += '-DTEST_TIMER_EN' '-DTEST_WDOG_EN' '-DTEST_POST_EN' '-DIEC_BOARD_HEADER="sl_iec60730_board.h"'

-include comp_comm.mk

# Object files
OBJS += Test_post.o iec60730_oem_timer.o em_wdog.o iec60730_system_clock.o iec60730_watchdog.o iec60730_programme_counter.o

# Build all specific source files
Test_post.o: $(TEST_DIR)/src/Test_post.c
	$(CC) $(CFLAGS) $(CMSE_FLAG) $(DEPENDENCIES_FLAG) $(CUR_BUILDDIR)/Test_post.d -o $(CUR_BUILDDIR)/$@ $^
	@echo ' '
