...
DEFS += '-DTEST_TIMER_EN' '-DTEST_WDOG_EN' '-DTEST_INTEGRATED_EN' '-DIEC_BOARD_HEADER="sl_iec60730_board.h"' '-DIEC60730_RSTCAUSES_CLEAR_ENABLE' '-DIEC60730_SAVE_STAGE_ENABLE'
...
iec60730_cpu_registers.o: $(COMP_DIR)/src/sl_iec60730_cpu_registers.c
	@echo 'Building file: $<'
	@echo 'Invoking: $(COMPILER) ARM C Compiler'
...
iec60730_invariable_memory.o: $(COMP_DIR)/src/sl_iec60730_invariable_memory.c
	@echo 'Building file: $<'
	@echo 'Invoking: $(COMPILER) ARM C Compiler'
...
iec60730_irq.o: $(COMP_DIR)/src/sl_iec60730_irq.c
	@echo 'Building file: $<'
	@echo 'Invoking: $(COMPILER) ARM C Compiler'
...
iec60730_variable_memory.o: $(COMP_DIR)/src/sl_iec60730_variable_memory.c
	@echo 'Building file: $<'
	@echo 'Invoking: $(COMPILER) ARM C Compiler'
