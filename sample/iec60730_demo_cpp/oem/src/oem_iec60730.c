...
volatile SL_IEC60730_IRQ_TYPE_VARIABLE oem_irq_exec_count[IEC60730_IRQ_SIZE] = {
    0};
const sl_iec60730_irq_execution_bounds_t
    oem_irq_freq_bounds[IEC60730_IRQ_SIZE] = {{.min = 9, .max = 11},
                                              {.min = 9, .max = 11},
                                              {.min = 9, .max = 11},
                                              {.min = 9, .max = 11},
                                              {.min = 9, .max = 11},
