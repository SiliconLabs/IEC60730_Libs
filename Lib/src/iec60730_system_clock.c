...
void iec60730_TestClockTick(void)
{
  ...
  if (iec60730_timerTestControl == iec60730_TimerTestEnable)
  {
    ...
    if ((iec60730_systemClockCounter > (iec60730_systemClockToTestClockFrequency + iec60730_clockTestTolerance))
     || (iec60730_systemClockCounter < (iec60730_systemClockToTestClockFrequency - iec60730_clockTestTolerance)))
    {
