...
SI_SEGMENT_VARIABLE(iec60730_SafetyCheck, iec60730_TestFailure_t, SI_SEG_DATA) = iec60730_NoFailure;

void iec60730_Bist(void)
{
  iec60730_TestResult_t result;   ///< Temporary storage of the result of each test
