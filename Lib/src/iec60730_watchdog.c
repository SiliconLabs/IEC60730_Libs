...
static SI_SEGMENT_VARIABLE(iec60730_WatchdogCount, uint8_t, SI_SEG_DATA_NO_CLEAR);
...
iec60730_TestResult_t iec60730_WatchdogPost(void)
{
  ...
  if (IEC60730_RST_POR && !IEC60730_RST_WDOGS){
    ...
    if (IEC60730_RST_EM4){
      iec60730_WatchdogState = (iec60730_TestWatchdog_t)IEC60730_BURAM_READ(IEC60730_BURAM,
                                                                        IEC60730_BURAM_IDX);
    }
    #endif
