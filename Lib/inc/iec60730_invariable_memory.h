 ...
 * CRC software.
 *
 * With case CRC software is choosed, the default is calculate CRC-table in
 ...
 * \ref runCrc is less than #ROM_END, every time funtion #iec60730_ImcBist is
 * invoked, the value of \ref runCrc increases by #FLASH_BLOCK_WORDS. Otherwise,
 * calculating \ref curCrc and compare it wit value of \ref refCrc or value
 * stored in #REF_CRC.
 *
 ...
 * \image html invariable_memory_check_example_flowchart.png "Figure 1 Example of caculating CRC"
 *
...
/// If using #CRC_USE_SW defintion then the #SW_CRC_TABLE definition is used for
/// using pre-defined table for caculating.
#define SW_CRC_TABLE
