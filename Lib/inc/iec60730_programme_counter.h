/***************************************************************************//**
 * @file    iec60730_programme_counter.h
 ...
 * 
 * Bits within #iec60730_programmeCounterCheck are set as tests pass. OEMs can determine
...
///
/// Checks flags in #iec60730_programmeCounterCheck set by each BIST test to determine if BIST is
/// executing within a specified period.
/// @return #iec60730_TestResult_t. If test fails, returns #iec60730_TestFailed;
/// otherwise #iec60730_TestPassed.
