function(generate_integration_test relative_dir target_name)
  ...
  if(TEST_SECURE_PERIPHERALS_ENABLE)
    ...
    if(${target_name} STREQUAL "integration_test_iec60730_variable_memory")
      ...
      string(REPLACE "SL_TRUSTZONE_SECURE=1" "" COMPILE_DEFINITIONS_SUPPORT_VMC "${COMPILE_DEFINITIONS_IEC60730}")
      set_property(TARGET slc_lib_iec60730 PROPERTY COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS_SUPPORT_VMC})
      message("-- [I] ${target_name} COMPILE_DEFINITIONS: ${COMPILE_DEFINITIONS_SUPPORT_VMC}")
    else()
      ...
      set_property(TARGET slc_lib_iec60730 PROPERTY COMPILE_DEFINITIONS ${COMPILE_DEFINITIONS_IEC60730})
      #message("-- [I] ${target_name} COMPILE_DEFINITIONS: ${COMPILE_DEFINITIONS_IEC60730}")
    endif()
  else()
