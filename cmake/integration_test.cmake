function(generate_integration_test relative_dir target_name)
  ...
  if(TEST_NON_SECURE_PERIPHERALS_ENABLE)
  ...
  if(TEST_NON_SECURE_PERIPHERALS_ENABLE)
    set(DEFINE_TEST_NON_SECURE_PERIPHERALS_ENABLE "TEST_NON_SECURE_PERIPHERALS_ENABLE")
  else()
    set(DEFINE_TEST_NON_SECURE_PERIPHERALS_ENABLE "NON_SECURE_PERIPHERALS_ENABLE")
  endif()
  ...
  target_compile_definitions(${INTEGRATION_TEST_NAME} PUBLIC ${DEFINE_INTEGRATION_TEST}_ENABLE
                                                      ...
                                                      ${DEFINE_TEST_NON_SECURE_PERIPHERALS_ENABLE})
