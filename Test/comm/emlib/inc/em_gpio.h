...
__STATIC_INLINE void GPIO_DbgSWDClkEnable(bool enable)
{
  ...
  BUS_RegBitWrite(&(IEC_P_INST(GPIO)->ROUTE), _GPIO_ROUTE_SWCLKPEN_SHIFT, enable);
#elif defined(_GPIO_ROUTEPEN_SWCLKTCKPEN_MASK)
  BUS_RegBitWrite(&(IEC_P_INST(GPIO)->ROUTEPEN), _GPIO_ROUTEPEN_SWCLKTCKPEN_SHIFT, enable);
#elif defined(_GPIO_DBGROUTEPEN_SWCLKTCKPEN_MASK)
  BUS_RegBitWrite(&(IEC_P_INST(GPIO)->DBGROUTEPEN), _GPIO_DBGROUTEPEN_SWCLKTCKPEN_SHIFT, enable);
#else
...
__STATIC_INLINE void GPIO_DbgSWDIOEnable(bool enable)
{
  ...
  BUS_RegBitWrite(&(IEC_P_INST(GPIO)->ROUTE), _GPIO_ROUTE_SWDIOPEN_SHIFT, enable);
#elif defined(_GPIO_ROUTEPEN_SWDIOTMSPEN_MASK)
  BUS_RegBitWrite(&(IEC_P_INST(GPIO)->ROUTEPEN), _GPIO_ROUTEPEN_SWDIOTMSPEN_SHIFT, enable);
#elif defined(_GPIO_DBGROUTEPEN_SWDIOTMSPEN_MASK)
  BUS_RegBitWrite(&(IEC_P_INST(GPIO)->DBGROUTEPEN), _GPIO_DBGROUTEPEN_SWDIOTMSPEN_SHIFT, enable);
#else
...
__STATIC_INLINE void GPIO_DbgSWOEnable(bool enable)
{
  ...
  BUS_RegBitWrite(&(IEC_P_INST(GPIO)->ROUTE), _GPIO_ROUTE_SWOPEN_SHIFT, enable);
#elif defined(_GPIO_ROUTEPEN_SWVPEN_MASK)
  BUS_RegBitWrite(&(IEC_P_INST(GPIO)->ROUTEPEN), _GPIO_ROUTEPEN_SWVPEN_SHIFT, enable);
#elif defined(_GPIO_TRACEROUTEPEN_SWVPEN_MASK)
  BUS_RegBitWrite(&(IEC_P_INST(GPIO)->TRACEROUTEPEN), _GPIO_TRACEROUTEPEN_SWVPEN_SHIFT, enable);
#else
...
__STATIC_INLINE void GPIO_EM4DisablePinWakeup(uint32_t pinmask)
{
  ...
  IEC_P_INST(GPIO)->EM4WUEN &= ~pinmask;
}
#endif
...
__STATIC_INLINE uint32_t GPIO_EM4GetPinWakeupCause(void)
{
  ...
  return IEC_P_INST(GPIO)->EM4WUCAUSE & _GPIO_EM4WUCAUSE_MASK;
#else
  return IEC_P_INST(GPIO)->IF & _GPIO_IF_EM4WU_MASK;
#endif
}
#endif
...
__STATIC_INLINE void GPIO_EM4SetPinRetention(bool enable)
{
  ...
  BUS_RegBitWrite(&IEC_P_INST(GPIO)->CTRL, _GPIO_CTRL_EM4RET_SHIFT, enable);
#else
...
__STATIC_INLINE void GPIO_InputSenseSet(uint32_t val, uint32_t mask)
{
  ...
  IEC_P_INST(GPIO)->INSENSE = (IEC_P_INST(GPIO)->INSENSE & ~mask) | (val & mask);
#else
  (void) val;
  (void) mask;
#endif
...
__STATIC_INLINE void GPIO_IntClear(uint32_t flags)
{
  ...
  IEC_P_INST(GPIO)->IF_CLR = flags;
#else
  IEC_P_INST(GPIO)->IFC = flags;
#endif
}
...
__STATIC_INLINE uint32_t GPIO_IntGetEnabled(void)
{
  ...
  /* Store IEC_P_INST(GPIO)->IEN in temporary variable in order to define explicit order
   * of volatile accesses. */
  tmp = IEC_P_INST(GPIO)->IEN;

  /* Bitwise AND of pending and enabled interrupts */
  return IEC_P_INST(GPIO)->IF & tmp;
}
...
{
#if defined (GPIO_HAS_SET_CLEAR)
  IEC_P_INST(GPIO)->IF_SET = flags;
#else
  IEC_P_INST(GPIO)->IFS = flags;
#endif
}
...
{
  IEC_P_INST(GPIO)->LOCK = ~GPIO_LOCK_LOCKKEY_UNLOCK;
}
                                           ...
                                           unsigned int pin)
{
  ...
  return BUS_RegBitRead(&IEC_P_INST(GPIO)->P[port].DIN, pin);
}
...
{
  BUS_RegBitWrite(&IEC_P_INST(GPIO)->P[port].PINLOCKN, pin, 0);
}
#endif
...
__STATIC_INLINE void GPIO_PinOutClear(GPIO_Port_TypeDef port, unsigned int pin)
{
  ...
  IEC_P_INST(GPIO)->P[port].DOUTCLR = 1 << pin;
#elif defined(GPIO_HAS_SET_CLEAR)
  IEC_P_INST(GPIO)->P_CLR[port].DOUT = 1 << pin;
#else
  BUS_RegMaskedClear(&IEC_P_INST(GPIO)->P[port].DOUT, 1 << pin);
#endif
}
...
{
  EFM_ASSERT(GPIO_PORT_PIN_VALID(port, pin));
  return BUS_RegBitRead(&IEC_P_INST(GPIO)->P[port].DOUT, pin);
}
...
__STATIC_INLINE void GPIO_PinOutSet(GPIO_Port_TypeDef port, unsigned int pin)
{
  ...
  IEC_P_INST(GPIO)->P[port].DOUTSET = 1 << pin;
#elif defined(GPIO_HAS_SET_CLEAR)
  IEC_P_INST(GPIO)->P_SET[port].DOUT = 1 << pin;
#else
  BUS_RegMaskedSet(&IEC_P_INST(GPIO)->P[port].DOUT, 1 << pin);
#endif
}
...
__STATIC_INLINE void GPIO_PinOutToggle(GPIO_Port_TypeDef port, unsigned int pin)
{
  ...
  IEC_P_INST(GPIO)->P[port].DOUTTGL = 1 << pin;
#elif defined(GPIO_HAS_SET_CLEAR)
  IEC_P_INST(GPIO)->P_TGL[port].DOUT = 1 << pin;
#else
  IEC_P_INST(GPIO)->P[port].DOUT ^= 1 << pin;
#endif
}
...
__STATIC_INLINE uint32_t GPIO_PortInGet(GPIO_Port_TypeDef port)
{
  ...
  return IEC_P_INST(GPIO)->P[port].DIN;
}
...
__STATIC_INLINE void GPIO_PortOutClear(GPIO_Port_TypeDef port, uint32_t pins)
{
  EFM_ASSERT(GPIO_PORT_VALID(port));
#if defined(_GPIO_P_DOUTCLR_MASK)
  IEC_P_INST(GPIO)->P[port].DOUTCLR = pins;
#elif defined(GPIO_HAS_SET_CLEAR)
  IEC_P_INST(GPIO)->P_CLR[port].DOUT = pins;
#else
  BUS_RegMaskedClear(&IEC_P_INST(GPIO)->P[port].DOUT, pins);
#endif
}
...
__STATIC_INLINE uint32_t GPIO_PortOutGet(GPIO_Port_TypeDef port)
{
  ...
  return IEC_P_INST(GPIO)->P[port].DOUT;
}
...
__STATIC_INLINE void GPIO_PortOutSet(GPIO_Port_TypeDef port, uint32_t pins)
{
  EFM_ASSERT(GPIO_PORT_VALID(port));
#if defined(_GPIO_P_DOUTSET_MASK)
  IEC_P_INST(GPIO)->P[port].DOUTSET = pins;
#elif defined(GPIO_HAS_SET_CLEAR)
  IEC_P_INST(GPIO)->P_SET[port].DOUT = pins;
#else
  BUS_RegMaskedSet(&IEC_P_INST(GPIO)->P[port].DOUT, pins);
#endif
}
                                        ...
                                        uint32_t mask)
{
  ...
  IEC_P_INST(GPIO)->P[port].DOUT = (IEC_P_INST(GPIO)->P[port].DOUT & ~mask) | (val & mask);
}
...
__STATIC_INLINE void GPIO_PortOutToggle(GPIO_Port_TypeDef port, uint32_t pins)
{
  EFM_ASSERT(GPIO_PORT_VALID(port));
#if defined (GPIO_HAS_SET_CLEAR)
  IEC_P_INST(GPIO)->P_TGL[port].DOUT = pins;
#else
  IEC_P_INST(GPIO)->P[port].DOUTTGL = pins;
#endif
}
                                      ...
                                      uint32_t slewrateAlt)
{
  ...
  IEC_P_INST(GPIO)->P[port].CTRL = (IEC_P_INST(GPIO)->P[port].CTRL
