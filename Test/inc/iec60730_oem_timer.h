...
/* Test Timer instance */
#ifdef TEST_NONSECURE_ENABLE
#define TEST_Timer_10ms   TIMER0_NS
#define TEST_Timer_100ms  LETIMER0_NS
#else
#define TEST_Timer_10ms   TIMER0
#define TEST_Timer_100ms  LETIMER0
#endif
...
/* Timer prescaler is 4 so counter clock is 5Mhz () */
