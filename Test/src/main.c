...
void Smu_Config(void)
{
  ...
  SMU_S->PPUSATD0_CLR = (SMU_PPUSATD0_CMU | SMU_PPUSATD0_HFRCO0 | SMU_PPUSATD0_FSRCO | SMU_PPUSATD0_DPLL0 |
                        SMU_PPUSATD0_LFXO | SMU_PPUSATD0_LFRCO | SMU_PPUSATD0_GPIO | SMU_PPUSATD0_TIMER0 |
                        SMU_PPUSATD0_BURAM | SMU_PPUSATD0_GPCRC | SMU_PPUSATD0_EMU) & _SMU_PPUSATD0_MASK;
  /* WDOG0, WDOG1 non-secure */
  SMU_S->PPUSATD1_CLR = (SMU_PPUSATD1_LETIMER0 | SMU_PPUSATD1_WDOG0 | SMU_PPUSATD1_WDOG1) & _SMU_PPUSATD1_MASK;
  /* Flash Secure region */
