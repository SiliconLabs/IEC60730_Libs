...
*/
#define SAU_INIT_START0                                                        \
  (FLASH_MEM_BASE + 0x00020000) /* start address of SAU region 0 */

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END0                                                          \
  (FLASH_MEM_BASE + 0x00027FE0) /* end address of SAU region 0 */
