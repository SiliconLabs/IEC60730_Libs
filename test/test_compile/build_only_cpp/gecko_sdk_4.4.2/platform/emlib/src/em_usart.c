...
#define USART_REF_VALID(ref)                                                   \
  (((ref) == USART0) || ((ref) == USART1) || ((ref) == USART2))
#elif (USART_COUNT == 4)
#define USART_REF_VALID(ref)                                                   \
  (((ref) == USART0) || ((ref) == USART1) || ((ref) == USART2)                 \
   || ((ref) == USART3))
...
#define USART_REF_VALID(ref)                                                   \
  (((ref) == USART0) || ((ref) == USART1) || ((ref) == USART2)                 \
   || ((ref) == USART3) || ((ref) == USART4) || ((ref) == USART5))
#else
...
#define USART_I2S_VALID(ref)                                                   \
  (((ref) == USART1) || ((ref) == USART3) || ((ref) == USART4))
#elif defined(USART3)
...
static void prsRxInput(USART_TypeDef *usart, USART_PRS_Channel_t ch)
{
  ...
  usart->INPUT =
      ((uint32_t) ch << _USART_INPUT_RXPRSSEL_SHIFT) | USART_INPUT_RXPRS;
...
static void prsIrInput(USART_TypeDef *usart, USART_PRS_Channel_t ch)
{
  ...
  usart->IRCTRL |=
      ((uint32_t) ch << _USART_IRCTRL_IRPRSSEL_SHIFT) | USART_IRCTRL_IRPRSEN;
#else
  (void) ch;
...
void USART_InitAsync(USART_TypeDef *usart, const USART_InitAsync_TypeDef *init)
{
  ...
  usart->TIMING =
      (((uint32_t) init->autoCsHold << _USART_TIMING_CSHOLD_SHIFT)
  ...
  usart->ROUTEPEN &=
      ~(_USART_ROUTEPEN_RTSPEN_MASK | _USART_ROUTEPEN_CTSPEN_MASK);
