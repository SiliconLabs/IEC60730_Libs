...
#define GPIO_STRENGTH_VALID(strength)                                          \
  (!((strength)                                                                \
 ...
 *
 * @note
 *   The selected port/pin must be mapped to an existent EM4WU interrupt.
 ...
 *
 * @param[in] out
 *   A value to set for the pin in the DOUBT register. The DOUBT setting is important for
                     ...
                     unsigned int out)
{
  ...
  /* If disabling a pin, do not modify DOUBT to reduce the chance of */
