...
SL_ENUM_GENERIC(CMU_HFXORefFreq_TypeDef, uint32_t){
    cmuHFXORefFreq_38M0Hz =
        (1UL << _USBPLL_CTRL_DIVR_SHIFT) | (24UL << _USBPLL_CTRL_DIVX_SHIFT)
        | (19UL << _USBPLL_CTRL_DIVN_SHIFT), /**< 38MHz input frequency.   */
    cmuHFXORefFreq_38M4Hz =
        (1UL << _USBPLL_CTRL_DIVR_SHIFT) | (25UL << _USBPLL_CTRL_DIVX_SHIFT)
        | (20UL << _USBPLL_CTRL_DIVN_SHIFT), /**< 38.4MHz input frequency. */
    cmuHFXORefFreq_39M0Hz =
        (1UL << _USBPLL_CTRL_DIVR_SHIFT) | (16UL << _USBPLL_CTRL_DIVX_SHIFT)
...
SL_ENUM_GENERIC(CMU_Clock_TypeDef, uint32_t){
    ...
    cmuClock_SYSCLK  = (CMU_SYSCLK_BRANCH
                       << CMU_CLK_BRANCH_POS), /**< SYSTEM clock. */
    cmuClock_SYSTICK = (CMU_SYSTICK_BRANCH
                        << CMU_CLK_BRANCH_POS), /**< SYSTICK clock. */
    cmuClock_HCLK =
        (CMU_HCLK_BRANCH
         << CMU_CLK_BRANCH_POS), /**< Core and AHB bus interface clock. */
    cmuClock_EXPCLK = (CMU_EXPCLK_BRANCH
                       << CMU_CLK_BRANCH_POS), /**< Export clock. */
    cmuClock_PCLK =
        (CMU_PCLK_BRANCH
         << CMU_CLK_BRANCH_POS), /**< Peripheral APB bus interface clock. */
    cmuClock_LSPCLK =
        (CMU_LSPCLK_BRANCH
         << CMU_CLK_BRANCH_POS), /**< Low speed peripheral APB bus interface clock. */
    cmuClock_TRACECLK    = (CMU_TRACECLK_BRANCH
                         << CMU_CLK_BRANCH_POS), /**< Debug trace. */
    cmuClock_EM01GRPACLK = (CMU_EM01GRPACLK_BRANCH
                            << CMU_CLK_BRANCH_POS), /**< EM01GRPA clock. */
#if defined(PDM_PRESENT)
    cmuClock_EM01GRPBCLK = (CMU_EM01GRPBCLK_BRANCH
                            << CMU_CLK_BRANCH_POS), /**< EM01GRPB clock. */
#endif
#if defined(_CMU_EM01GRPCCLKCTRL_MASK)
    cmuClock_EM01GRPCCLK = (CMU_EM01GRPCCLK_BRANCH
                            << CMU_CLK_BRANCH_POS), /**< EM01GRPC clock. */
#endif
#if defined(EUART_PRESENT)
    cmuClock_EUART0CLK = (CMU_EUART0CLK_BRANCH
                          << CMU_CLK_BRANCH_POS), /**< EUART0 clock. */
#elif defined(EUSART_PRESENT)
    cmuClock_EUSART0CLK = (CMU_EUART0CLK_BRANCH
                           << CMU_CLK_BRANCH_POS), /**< EUSART0 clock. */
#endif
    cmuClock_IADCCLK     = (CMU_IADCCLK_BRANCH
                        << CMU_CLK_BRANCH_POS), /**< IADC clock. */
    cmuClock_EM23GRPACLK = (CMU_EM23GRPACLK_BRANCH
                            << CMU_CLK_BRANCH_POS), /**< EM23GRPA clock. */
    cmuClock_WDOG0CLK    = (CMU_WDOG0CLK_BRANCH
                         << CMU_CLK_BRANCH_POS), /**< WDOG0 clock. */
#if WDOG_COUNT > 1
    cmuClock_WDOG1CLK = (CMU_WDOG1CLK_BRANCH
                         << CMU_CLK_BRANCH_POS), /**< WDOG1 clock. */
#endif
#if defined(RTCC_PRESENT)
    cmuClock_RTCCCLK = (CMU_RTCCCLK_BRANCH
                        << CMU_CLK_BRANCH_POS), /**< RTCC clock. */
#elif defined(SYSRTC_PRESENT)
    cmuClock_SYSRTCCLK = (CMU_SYSRTCCLK_BRANCH
                          << CMU_CLK_BRANCH_POS), /**< SYSRTC clock. */
#endif
    cmuClock_EM4GRPACLK = (CMU_EM4GRPACLK_BRANCH
                           << CMU_CLK_BRANCH_POS), /**< EM4GRPA clock. */
    cmuClock_DPLLREFCLK = (CMU_DPLLREFCLK_BRANCH
                           << CMU_CLK_BRANCH_POS), /**< DPLLREF clock. */
#if defined(CRYPTOACC_PRESENT)
    cmuClock_CRYPTOAES = (CMU_CRYPTOACCCLKCTRL_EN_REG << CMU_EN_REG_POS)
                         | (_CMU_CRYPTOACCCLKCTRL_AESEN_SHIFT
                            << CMU_EN_BIT_POS), /**< CRYPTOAES clock. */
    cmuClock_CRYPTOPK = (CMU_CRYPTOACCCLKCTRL_EN_REG << CMU_EN_REG_POS)
                        | (_CMU_CRYPTOACCCLKCTRL_PKEN_SHIFT
                           << CMU_EN_BIT_POS), /**< CRYPTOPK clock. */
#endif
#if defined(LCD_PRESENT)
    cmuClock_LCDCLK = (CMU_LCD_BRANCH << CMU_CLK_BRANCH_POS), /**< LCD clock. */
#endif
#if defined(VDAC_PRESENT)
    cmuClock_VDAC0CLK = (CMU_VDAC0_BRANCH
                         << CMU_CLK_BRANCH_POS), /**< VDAC0 clock. */
#if (VDAC_COUNT > 1)
    cmuClock_VDAC1CLK = (CMU_VDAC1_BRANCH
                         << CMU_CLK_BRANCH_POS), /**< VDAC1 clock. */
#endif
#endif
#if defined(PCNT_PRESENT)
    cmuClock_PCNT0CLK = (CMU_PCNT_BRANCH
                         << CMU_CLK_BRANCH_POS), /**< PCNT0 clock. */
#endif
#if defined(LESENSE_PRESENT)
    cmuClock_LESENSEHFCLK =
        (CMU_LESENSEHF_BRANCH
         << CMU_CLK_BRANCH_POS), /**< LESENSE high frequency clock. */
    cmuClock_LESENSECLK =
        (CMU_LESENSE_BRANCH
         << CMU_CLK_BRANCH_POS), /**< LESENSE low frequency clock. */
#endif

    cmuClock_CORE = (CMU_CORE_BRANCH
                     << CMU_CLK_BRANCH_POS), /**< Cortex-M33 core clock. */
#if defined(PDM_PRESENT)
    cmuClock_PDMREF = (CMU_PDMREF_BRANCH
                       << CMU_CLK_BRANCH_POS), /**< PDMREF clock. */
#endif
    /*********************/
    /* Peripheral clocks */
    /*********************/
...
SL_ENUM_GENERIC(CMU_LfxoOscMode_TypeDef, uint32_t){
    ...
    cmuLfxoOscMode_AcCoupledSine =
        _LFXO_CFG_MODE_BUFEXTCLK, /**< External AC coupled sine. */
    cmuLfxoOscMode_External =
        _LFXO_CFG_MODE_DIGEXTCLK, /**< External digital clock. */
};

/** LFXO start-up timeout delay. */
SL_ENUM_GENERIC(CMU_LfxoStartupDelay_TypeDef, uint32_t){
    cmuLfxoStartupDelay_2Cycles =
        _LFXO_CFG_TIMEOUT_CYCLES2, /**< 2 cycles start-up delay. */
    cmuLfxoStartupDelay_256Cycles =
        _LFXO_CFG_TIMEOUT_CYCLES256, /**< 256 cycles start-up delay. */
    cmuLfxoStartupDelay_1KCycles =
        _LFXO_CFG_TIMEOUT_CYCLES1K, /**< 1K cycles start-up delay. */
    cmuLfxoStartupDelay_2KCycles =
        _LFXO_CFG_TIMEOUT_CYCLES2K, /**< 2K cycles start-up delay. */
    cmuLfxoStartupDelay_4KCycles =
        _LFXO_CFG_TIMEOUT_CYCLES4K, /**< 4K cycles start-up delay. */
    cmuLfxoStartupDelay_8KCycles =
        _LFXO_CFG_TIMEOUT_CYCLES8K, /**< 8K cycles start-up delay. */
    cmuLfxoStartupDelay_16KCycles =
        _LFXO_CFG_TIMEOUT_CYCLES16K, /**< 16K cycles start-up delay. */
    cmuLfxoStartupDelay_32KCycles =
        _LFXO_CFG_TIMEOUT_CYCLES32K, /**< 32K cycles start-up delay. */
};
...
SL_ENUM_GENERIC(CMU_HfxoOscMode_TypeDef, uint32_t){
    ...
    cmuHfxoOscMode_ExternalSine =
        _HFXO_CFG_MODE_EXTCLK, /**< External digital clock. */
#if defined(_HFXO_CFG_MODE_EXTCLKPKDET)
    cmuHfxoOscMode_ExternalSinePkDet =
        _HFXO_CFG_MODE_EXTCLKPKDET, /**< External digital clock with peak detector used. */
#endif
};
...
SL_ENUM_GENERIC(CMU_HfxoCbLsbTimeout_TypeDef, uint32_t){
    cmuHfxoCbLsbTimeout_8us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T8US, /**< 8 us timeout. */
    cmuHfxoCbLsbTimeout_20us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T20US, /**< 20 us timeout. */
    cmuHfxoCbLsbTimeout_41us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T41US, /**< 41 us timeout. */
    cmuHfxoCbLsbTimeout_62us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T62US, /**< 62 us timeout. */
    cmuHfxoCbLsbTimeout_83us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T83US, /**< 83 us timeout. */
    cmuHfxoCbLsbTimeout_104us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T104US, /**< 104 us timeout. */
    cmuHfxoCbLsbTimeout_125us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T125US, /**< 125 us timeout. */
    cmuHfxoCbLsbTimeout_166us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T166US, /**< 166 us timeout. */
    cmuHfxoCbLsbTimeout_208us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T208US, /**< 208 us timeout. */
    cmuHfxoCbLsbTimeout_250us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T250US, /**< 250 us timeout. */
    cmuHfxoCbLsbTimeout_333us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T333US, /**< 333 us timeout. */
    cmuHfxoCbLsbTimeout_416us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T416US, /**< 416 us timeout. */
    cmuHfxoCbLsbTimeout_833us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T833US, /**< 833 us timeout. */
    cmuHfxoCbLsbTimeout_1250us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T1250US, /**< 1250 us timeout. */
    cmuHfxoCbLsbTimeout_2083us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T2083US, /**< 2083 us timeout. */
    cmuHfxoCbLsbTimeout_3750us =
        _HFXO_XTALCFG_TIMEOUTCBLSB_T3750US, /**< 3750 us timeout. */
};

/** HFXO steady state timeout. */
SL_ENUM_GENERIC(CMU_HfxoSteadyStateTimeout_TypeDef, uint32_t){
    cmuHfxoSteadyStateTimeout_16us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T16US, /**< 16 us timeout. */
    cmuHfxoSteadyStateTimeout_41us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T41US, /**< 41 us timeout. */
    cmuHfxoSteadyStateTimeout_83us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T83US, /**< 83 us timeout. */
    cmuHfxoSteadyStateTimeout_125us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T125US, /**< 125 us timeout. */
    cmuHfxoSteadyStateTimeout_166us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T166US, /**< 166 us timeout. */
    cmuHfxoSteadyStateTimeout_208us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T208US, /**< 208 us timeout. */
    cmuHfxoSteadyStateTimeout_250us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T250US, /**< 250 us timeout. */
    cmuHfxoSteadyStateTimeout_333us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T333US, /**< 333 us timeout. */
    cmuHfxoSteadyStateTimeout_416us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T416US, /**< 416 us timeout. */
    cmuHfxoSteadyStateTimeout_500us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T500US, /**< 500 us timeout. */
    cmuHfxoSteadyStateTimeout_666us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T666US, /**< 666 us timeout. */
    cmuHfxoSteadyStateTimeout_833us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T833US, /**< 833 us timeout. */
    cmuHfxoSteadyStateTimeout_1666us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T1666US, /**< 1666 us timeout. */
    cmuHfxoSteadyStateTimeout_2500us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T2500US, /**< 2500 us timeout. */
    cmuHfxoSteadyStateTimeout_4166us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T4166US, /**< 4166 us timeout. */
#if defined(_HFXO_XTALCFG_TIMEOUTSTEADY_T7500US)
    cmuHfxoSteadyStateTimeout_7500us =
        _HFXO_XTALCFG_TIMEOUTSTEADY_T7500US, /**< 7500 us timeout. */
#endif
};
...
SL_ENUM_GENERIC(CMU_HfxoCoreDegen_TypeDef, uint32_t){
    cmuHfxoCoreDegen_None =
        _HFXO_XTALCTRL_COREDGENANA_NONE, /**< No core degeneration. */
    cmuHfxoCoreDegen_33 =
        _HFXO_XTALCTRL_COREDGENANA_DGEN33, /**< Core degeneration control 33. */
    cmuHfxoCoreDegen_50 =
        _HFXO_XTALCTRL_COREDGENANA_DGEN50, /**< Core degeneration control 50. */
    cmuHfxoCoreDegen_100 =
        _HFXO_XTALCTRL_COREDGENANA_DGEN100, /**< Core degeneration control 100. */
};

/** HFXO XI and XO pin fixed capacitor control. */
SL_ENUM_GENERIC(CMU_HfxoCtuneFixCap_TypeDef, uint32_t){
    cmuHfxoCtuneFixCap_None =
        _HFXO_XTALCTRL_CTUNEFIXANA_NONE, /**< No fixed capacitors. */
    cmuHfxoCtuneFixCap_Xi =
        _HFXO_XTALCTRL_CTUNEFIXANA_XI, /**< Fixed capacitor on XI pin. */
    cmuHfxoCtuneFixCap_Xo =
        _HFXO_XTALCTRL_CTUNEFIXANA_XO, /**< Fixed capacitor on XO pin. */
    cmuHfxoCtuneFixCap_Both =
        _HFXO_XTALCTRL_CTUNEFIXANA_BOTH, /**< Fixed capacitor on both pins. */
};
...
typedef struct {
  ...
  CMU_HfxoSteadyStateTimeout_TypeDef
      timeoutSteadyFirstLock; /**< Steady state timeout duration for first lock. */
  CMU_HfxoSteadyStateTimeout_TypeDef
      timeoutSteady;         /**< Steady state timeout duration. */
  ...
  CMU_HfxoCtuneFixCap_TypeDef
      ctuneFixAna;              /**< Fixed tuning capacitance on XI/XO. */
...
SL_ENUM_GENERIC(CMU_BufoutTimeoutStartup_TypeDef, uint32_t){
    startupTimeout42Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T42US, /**< Timeout set to 42 us. */
    startupTimeout83Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T83US, /**< Timeout set to 83 us. */
    startupTimeout108Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T108US, /**< Timeout set to 108 us. */
    startupTimeout133Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T133US, /**< Timeout set to 133 us. */
    startupTimeout158Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T158US, /**< Timeout set to 158 us. */
    startupTimeout183Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T183US, /**< Timeout set to 183 us. */
    startupTimeout208Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T208US, /**< Timeout set to 208 us. */
    startupTimeout233Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T233US, /**< Timeout set to 233 us. */
    startupTimeout258Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T258US, /**< Timeout set to 258 us. */
    startupTimeout283Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T283US, /**< Timeout set to 283 us. */
    startupTimeout333Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T333US, /**< Timeout set to 333 us. */
    startupTimeout375Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T375US, /**< Timeout set to 375 us. */
    startupTimeout417Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T417US, /**< Timeout set to 417 us. */
    startupTimeout458Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T458US, /**< Timeout set to 458 us. */
    startupTimeout500Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T500US, /**< Timeout set to 500 us. */
    startupTimeout667Us =
        _HFXO_BUFOUTCTRL_TIMEOUTSTARTUP_T667US, /**< Timeout set to 667 us. */
};

/** Crystal sharing leader initialization structure. */
typedef struct {
  bool
      minimalStartupDelay; /**< If enabled, bufout won't start until timeout expires. */
  CMU_BufoutTimeoutStartup_TypeDef
      timeoutStartup; /**< Wait duration of the oscillator startup sequence to prevent bufout starting too early. */
...
typedef struct {
  CMU_PRS_Status_Output_Select_TypeDef
      prsStatusSelectOutput; /**< PRS status output select.  */
 ...
 *****************************   PROTOTYPES   **********************************
 ******************************************************************************/
uint32_t CMU_Calibrate(uint32_t cycles, CMU_Select_TypeDef reference);
...
void CMU_HFXOStartCrystalSharingLeader(
    const CMU_BUFOUTLeaderInit_TypeDef *bufoutInit,
    GPIO_Port_TypeDef port,
    unsigned int pin);
#endif
#if defined(_HFXO_CTRL_PRSSTATUSSEL0_MASK)
...
#if defined(_CMU_CTRL_HFCLKDIV_MASK) || defined(_CMU_HFPRESC_MASK)
...
/** @endcond */
    ...
    || defined(_CMU_HFXOCTRL_PEAKDETMODE_MASK)
/** HFXO tuning modes */
SL_ENUM_GENERIC(CMU_HFXOTuningMode_TypeDef, uint32_t){
    cmuHFXOTuningMode_Auto = 0,
    cmuHFXOTuningMode_PeakDetectCommand =
        CMU_CMD_HFXOPEAKDETSTART, /**< Run peak detect optimization only. */
#if defined(CMU_CMD_HFXOSHUNTOPTSTART)
    cmuHFXOTuningMode_ShuntCommand =
        CMU_CMD_HFXOSHUNTOPTSTART, /**< Run shunt current optimization only. */
    cmuHFXOTuningMode_PeakShuntCommand =
        CMU_CMD_HFXOPEAKDETSTART /**< Run peak and shunt current optimization. */
...
SL_ENUM_GENERIC(CMU_DPLLClkSel_TypeDef, uint32_t){
    cmuDPLLClkSel_Hfxo =
        _CMU_DPLLCTRL_REFSEL_HFXO, /**< HFXO is DPLL reference clock. */
    cmuDPLLClkSel_Lfxo =
        _CMU_DPLLCTRL_REFSEL_LFXO, /**< LFXO is DPLL reference clock. */
    cmuDPLLClkSel_Clkin0 =
        _CMU_DPLLCTRL_REFSEL_CLKIN0 /**< CLKIN0 is DPLL reference clock. */
};

/** DPLL reference clock edge detect selector. */
SL_ENUM_GENERIC(CMU_DPLLEdgeSel_TypeDef, uint32_t){
    cmuDPLLEdgeSel_Fall =
        _CMU_DPLLCTRL_EDGESEL_FALL, /**< Detect falling edge of reference clock. */
    cmuDPLLEdgeSel_Rise =
        _CMU_DPLLCTRL_EDGESEL_RISE /**< Detect rising edge of reference clock. */
};

/** DPLL lock mode selector. */
SL_ENUM_GENERIC(CMU_DPLLLockMode_TypeDef, uint32_t){
    cmuDPLLLockMode_Freq =
        _CMU_DPLLCTRL_MODE_FREQLL, /**< Frequency lock mode. */
...
typedef struct {
  ...
  uint16_t
      ctuneSteadyState; /**< Steady-state phase CTUNE (load capacitance) value */
  uint16_t xoCoreBiasTrimStartup; /**< Startup XO core bias current trim */
  uint16_t
      xoCoreBiasTrimSteadyState; /**< Steady-state XO core bias current trim */
  ...
  bool
      autoStartEm01; /**< @deprecated Use @ref CMU_HFXOAutostartEnable instead. */
  bool
      autoSelEm01; /**< @deprecated Use @ref CMU_HFXOAutostartEnable instead. */
  bool
      autoStartSelOnRacWakeup; /**< @deprecated Use @ref CMU_HFXOAutostartEnable instead. */
  uint16_t ctuneStartup; /**< Startup phase CTUNE (load capacitance) value */
  uint16_t
      ctuneSteadyState; /**< Steady-state phase CTUNE (load capacitance) value */
