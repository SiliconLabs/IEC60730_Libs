...
typedef enum {
  wdogClkSelULFRCO =
      _WDOG_CTRL_CLKSEL_ULFRCO, /**< Ultra low frequency (1 kHz) clock */
  wdogClkSelLFRCO = _WDOG_CTRL_CLKSEL_LFRCO, /**< Low frequency RC oscillator */
  wdogClkSelLFXO =
      _WDOG_CTRL_CLKSEL_LFXO /**< Low frequency crystal oscillator */
} WDOG_ClkSel_TypeDef;
#endif
...
typedef enum {
  ...
  wdogIllegalWindowTime12_5pct =
      1, /**< Window timeout is 12.5% of the timeout. */
  wdogIllegalWindowTime25_0pct =
      2, /**< Window timeout is 25% of the timeout. */
  wdogIllegalWindowTime37_5pct =
      3, /**< Window timeout is 37.5% of the timeout. */
  wdogIllegalWindowTime50_0pct =
      4, /**< Window timeout is 50% of the timeout. */
  wdogIllegalWindowTime62_5pct =
      5, /**< Window timeout is 62.5% of the timeout. */
  wdogIllegalWindowTime75_0pct =
      6, /**< Window timeout is 75% of the timeout. */
  wdogIllegalWindowTime87_5pct =
      7, /**< Window timeout is 87.5% of the timeout. */
} WDOG_WinSel_TypeDef;
#endif
...
#if defined(_WDOG_CTRL_CLRSRC_MASK) || defined(_WDOG_CFG_CLRSRC_MASK)
...
#elif defined(_WDOG_CTRL_WARNSEL_MASK) && defined(_WDOG_CTRL_WDOGRSTDIS_MASK)  \
