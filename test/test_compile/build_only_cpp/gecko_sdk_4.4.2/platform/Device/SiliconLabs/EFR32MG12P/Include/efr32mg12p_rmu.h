...
#define _RMU_CTRL_WDOGRMODE_DISABLED                                           \
  0x00000000UL /**< Mode DISABLED for RMU_CTRL */
#define _RMU_CTRL_WDOGRMODE_LIMITED                                            \
  0x00000001UL /**< Mode LIMITED for RMU_CTRL */
#define _RMU_CTRL_WDOGRMODE_EXTENDED                                           \
  0x00000002UL /**< Mode EXTENDED for RMU_CTRL */
#define _RMU_CTRL_WDOGRMODE_DEFAULT                                            \
  0x00000004UL                                /**< Mode DEFAULT for RMU_CTRL */
#define _RMU_CTRL_WDOGRMODE_FULL 0x00000004UL /**< Mode FULL for RMU_CTRL */
#define RMU_CTRL_WDOGRMODE_DISABLED                                            \
  (_RMU_CTRL_WDOGRMODE_DISABLED << 0) /**< Shifted mode DISABLED for RMU_CTRL */
#define RMU_CTRL_WDOGRMODE_LIMITED                                             \
  (_RMU_CTRL_WDOGRMODE_LIMITED << 0) /**< Shifted mode LIMITED for RMU_CTRL */
#define RMU_CTRL_WDOGRMODE_EXTENDED                                            \
  (_RMU_CTRL_WDOGRMODE_EXTENDED << 0) /**< Shifted mode EXTENDED for RMU_CTRL */
#define RMU_CTRL_WDOGRMODE_DEFAULT                                             \
  (_RMU_CTRL_WDOGRMODE_DEFAULT << 0) /**< Shifted mode DEFAULT for RMU_CTRL */
#define RMU_CTRL_WDOGRMODE_FULL                                                \
  (_RMU_CTRL_WDOGRMODE_FULL << 0)     /**< Shifted mode FULL for RMU_CTRL */
...
#define _RMU_CTRL_LOCKUPRMODE_DEFAULT                                          \
  0x00000000UL /**< Mode DEFAULT for RMU_CTRL */
#define _RMU_CTRL_LOCKUPRMODE_DISABLED                                         \
  0x00000000UL /**< Mode DISABLED for RMU_CTRL */
#define _RMU_CTRL_LOCKUPRMODE_LIMITED                                          \
  0x00000001UL /**< Mode LIMITED for RMU_CTRL */
#define _RMU_CTRL_LOCKUPRMODE_EXTENDED                                         \
  0x00000002UL /**< Mode EXTENDED for RMU_CTRL */
#define _RMU_CTRL_LOCKUPRMODE_FULL 0x00000004UL /**< Mode FULL for RMU_CTRL */
#define RMU_CTRL_LOCKUPRMODE_DEFAULT                                           \
  (_RMU_CTRL_LOCKUPRMODE_DEFAULT << 4) /**< Shifted mode DEFAULT for RMU_CTRL */
#define RMU_CTRL_LOCKUPRMODE_DISABLED                                          \
  (_RMU_CTRL_LOCKUPRMODE_DISABLED                                              \
   << 4) /**< Shifted mode DISABLED for RMU_CTRL */
#define RMU_CTRL_LOCKUPRMODE_LIMITED                                           \
  (_RMU_CTRL_LOCKUPRMODE_LIMITED << 4) /**< Shifted mode LIMITED for RMU_CTRL */
#define RMU_CTRL_LOCKUPRMODE_EXTENDED                                          \
  (_RMU_CTRL_LOCKUPRMODE_EXTENDED                                              \
   << 4) /**< Shifted mode EXTENDED for RMU_CTRL */
#define RMU_CTRL_LOCKUPRMODE_FULL                                              \
  (_RMU_CTRL_LOCKUPRMODE_FULL << 4)      /**< Shifted mode FULL for RMU_CTRL */
...
#define _RMU_CTRL_SYSRMODE_DISABLED                                            \
  0x00000000UL /**< Mode DISABLED for RMU_CTRL */
#define _RMU_CTRL_SYSRMODE_LIMITED                                             \
  0x00000001UL /**< Mode LIMITED for RMU_CTRL */
#define _RMU_CTRL_SYSRMODE_DEFAULT                                             \
  0x00000002UL /**< Mode DEFAULT for RMU_CTRL */
#define _RMU_CTRL_SYSRMODE_EXTENDED                                            \
  0x00000002UL                               /**< Mode EXTENDED for RMU_CTRL */
#define _RMU_CTRL_SYSRMODE_FULL 0x00000004UL /**< Mode FULL for RMU_CTRL */
#define RMU_CTRL_SYSRMODE_DISABLED                                             \
  (_RMU_CTRL_SYSRMODE_DISABLED << 8) /**< Shifted mode DISABLED for RMU_CTRL */
#define RMU_CTRL_SYSRMODE_LIMITED                                              \
  (_RMU_CTRL_SYSRMODE_LIMITED << 8) /**< Shifted mode LIMITED for RMU_CTRL */
#define RMU_CTRL_SYSRMODE_DEFAULT                                              \
  (_RMU_CTRL_SYSRMODE_DEFAULT << 8) /**< Shifted mode DEFAULT for RMU_CTRL */
#define RMU_CTRL_SYSRMODE_EXTENDED                                             \
  (_RMU_CTRL_SYSRMODE_EXTENDED << 8) /**< Shifted mode EXTENDED for RMU_CTRL */
#define RMU_CTRL_SYSRMODE_FULL                                                 \
  (_RMU_CTRL_SYSRMODE_FULL << 8)          /**< Shifted mode FULL for RMU_CTRL */
...
#define _RMU_CTRL_PINRMODE_EXTENDED                                            \
  0x00000002UL /**< Mode EXTENDED for RMU_CTRL */
#define _RMU_CTRL_PINRMODE_DEFAULT                                             \
  0x00000004UL                               /**< Mode DEFAULT for RMU_CTRL */
#define _RMU_CTRL_PINRMODE_FULL 0x00000004UL /**< Mode FULL for RMU_CTRL */
#define RMU_CTRL_PINRMODE_DISABLED                                             \
  (_RMU_CTRL_PINRMODE_DISABLED << 12) /**< Shifted mode DISABLED for RMU_CTRL */
#define RMU_CTRL_PINRMODE_LIMITED                                              \
  (_RMU_CTRL_PINRMODE_LIMITED << 12) /**< Shifted mode LIMITED for RMU_CTRL */
#define RMU_CTRL_PINRMODE_EXTENDED                                             \
  (_RMU_CTRL_PINRMODE_EXTENDED << 12) /**< Shifted mode EXTENDED for RMU_CTRL */
#define RMU_CTRL_PINRMODE_DEFAULT                                              \
  (_RMU_CTRL_PINRMODE_DEFAULT << 12) /**< Shifted mode DEFAULT for RMU_CTRL */
#define RMU_CTRL_PINRMODE_FULL                                                 \
  (_RMU_CTRL_PINRMODE_FULL << 12)     /**< Shifted mode FULL for RMU_CTRL */
#define _RMU_CTRL_RESETSTATE_SHIFT 24 /**< Shift value for RMU_RESETSTATE */
#define _RMU_CTRL_RESETSTATE_MASK                                              \
  0x3000000UL /**< Bit mask for RMU_RESETSTATE */
#define _RMU_CTRL_RESETSTATE_DEFAULT                                           \
  0x00000000UL /**< Mode DEFAULT for RMU_CTRL */
#define RMU_CTRL_RESETSTATE_DEFAULT                                            \
  (_RMU_CTRL_RESETSTATE_DEFAULT << 24) /**< Shifted mode DEFAULT for RMU_CTRL */

/* Bit fields for RMU RSTCAUSE */
#define _RMU_RSTCAUSE_RESETVALUE                                               \
  0x00000000UL /**< Default value for RMU_RSTCAUSE */
...
#define _RMU_RSTCAUSE_PORST_DEFAULT                                            \
  0x00000000UL /**< Mode DEFAULT for RMU_RSTCAUSE */
...
#define _RMU_RSTCAUSE_AVDDBOD_DEFAULT                                          \
  0x00000000UL /**< Mode DEFAULT for RMU_RSTCAUSE */
...
#define _RMU_RSTCAUSE_DVDDBOD_DEFAULT                                          \
  0x00000000UL /**< Mode DEFAULT for RMU_RSTCAUSE */
...
#define RMU_RSTCAUSE_DECBOD                                                    \
  (0x1UL << 4) /**< Brown Out Detector Decouple Domain Reset */
...
#define _RMU_RSTCAUSE_DECBOD_DEFAULT                                           \
  0x00000000UL /**< Mode DEFAULT for RMU_RSTCAUSE */
...
#define _RMU_RSTCAUSE_EXTRST_DEFAULT                                           \
  0x00000000UL /**< Mode DEFAULT for RMU_RSTCAUSE */
...
#define _RMU_RSTCAUSE_LOCKUPRST_DEFAULT                                        \
  0x00000000UL /**< Mode DEFAULT for RMU_RSTCAUSE */
...
#define _RMU_RSTCAUSE_SYSREQRST_DEFAULT                                        \
  0x00000000UL /**< Mode DEFAULT for RMU_RSTCAUSE */
...
#define _RMU_RSTCAUSE_WDOGRST_DEFAULT                                          \
  0x00000000UL /**< Mode DEFAULT for RMU_RSTCAUSE */
#define RMU_RSTCAUSE_WDOGRST_DEFAULT                                           \
  (_RMU_RSTCAUSE_WDOGRST_DEFAULT                                               \
   << 11) /**< Shifted mode DEFAULT for RMU_RSTCAUSE */
...
#define _RMU_RSTCAUSE_EM4RST_DEFAULT                                           \
  0x00000000UL /**< Mode DEFAULT for RMU_RSTCAUSE */
#define RMU_RSTCAUSE_EM4RST_DEFAULT                                            \
  (_RMU_RSTCAUSE_EM4RST_DEFAULT                                                \
   << 16) /**< Shifted mode DEFAULT for RMU_RSTCAUSE */
...
#define RMU_CMD_RCCLR_DEFAULT                                                  \
  (_RMU_CMD_RCCLR_DEFAULT << 0) /**< Shifted mode DEFAULT for RMU_CMD */
...
#define _RMU_LOCK_LOCKKEY_UNLOCKED                                             \
  0x00000000UL                                /**< Mode UNLOCKED for RMU_LOCK */
...
#define RMU_LOCK_LOCKKEY_DEFAULT                                               \
  (_RMU_LOCK_LOCKKEY_DEFAULT << 0) /**< Shifted mode DEFAULT for RMU_LOCK */
#define RMU_LOCK_LOCKKEY_UNLOCKED                                              \
  (_RMU_LOCK_LOCKKEY_UNLOCKED << 0) /**< Shifted mode UNLOCKED for RMU_LOCK */
#define RMU_LOCK_LOCKKEY_LOCK                                                  \
  (_RMU_LOCK_LOCKKEY_LOCK << 0) /**< Shifted mode LOCK for RMU_LOCK */
#define RMU_LOCK_LOCKKEY_LOCKED                                                \
  (_RMU_LOCK_LOCKKEY_LOCKED << 0) /**< Shifted mode LOCKED for RMU_LOCK */
#define RMU_LOCK_LOCKKEY_UNLOCK                                                \
  (_RMU_LOCK_LOCKKEY_UNLOCK << 0) /**< Shifted mode UNLOCK for RMU_LOCK */
