...
typedef struct {
  ...
  __IOM uint32_t
      BOOTLOADERCTRL; /**< Bootloader Read and Write Enable, Write Once Register  */
...
#define MSC_CTRL_ADDRFAULTEN                                                   \
  (0x1UL << 0) /**< Invalid Address Bus Fault Response Enable */
...
#define _MSC_CTRL_ADDRFAULTEN_DEFAULT                                          \
  0x00000001UL /**< Mode DEFAULT for MSC_CTRL */
#define MSC_CTRL_ADDRFAULTEN_DEFAULT                                           \
  (_MSC_CTRL_ADDRFAULTEN_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_CTRL */
#define MSC_CTRL_CLKDISFAULTEN                                                 \
  (0x1UL << 1) /**< Clock-disabled Bus Fault Response Enable */
#define _MSC_CTRL_CLKDISFAULTEN_SHIFT                                          \
  1 /**< Shift value for MSC_CLKDISFAULTEN */
#define _MSC_CTRL_CLKDISFAULTEN_MASK                                           \
  0x2UL /**< Bit mask for MSC_CLKDISFAULTEN */
#define _MSC_CTRL_CLKDISFAULTEN_DEFAULT                                        \
  0x00000000UL /**< Mode DEFAULT for MSC_CTRL */
#define MSC_CTRL_CLKDISFAULTEN_DEFAULT                                         \
  (_MSC_CTRL_CLKDISFAULTEN_DEFAULT                                             \
   << 1) /**< Shifted mode DEFAULT for MSC_CTRL */
#define MSC_CTRL_PWRUPONDEMAND                                                 \
  (0x1UL << 2) /**< Power Up on Demand During Wake Up */
#define _MSC_CTRL_PWRUPONDEMAND_SHIFT                                          \
  2 /**< Shift value for MSC_PWRUPONDEMAND */
#define _MSC_CTRL_PWRUPONDEMAND_MASK                                           \
  0x4UL /**< Bit mask for MSC_PWRUPONDEMAND */
#define _MSC_CTRL_PWRUPONDEMAND_DEFAULT                                        \
  0x00000000UL /**< Mode DEFAULT for MSC_CTRL */
#define MSC_CTRL_PWRUPONDEMAND_DEFAULT                                         \
  (_MSC_CTRL_PWRUPONDEMAND_DEFAULT                                             \
   << 2) /**< Shifted mode DEFAULT for MSC_CTRL */
...
#define _MSC_CTRL_IFCREADCLEAR_DEFAULT                                         \
  0x00000000UL /**< Mode DEFAULT for MSC_CTRL */
#define MSC_CTRL_IFCREADCLEAR_DEFAULT                                          \
  (_MSC_CTRL_IFCREADCLEAR_DEFAULT                                              \
   << 3) /**< Shifted mode DEFAULT for MSC_CTRL */
#define MSC_CTRL_TIMEOUTFAULTEN                                                \
  (0x1UL << 4) /**< Timeout Bus Fault Response Enable */
#define _MSC_CTRL_TIMEOUTFAULTEN_SHIFT                                         \
  4 /**< Shift value for MSC_TIMEOUTFAULTEN */
#define _MSC_CTRL_TIMEOUTFAULTEN_MASK                                          \
  0x10UL /**< Bit mask for MSC_TIMEOUTFAULTEN */
#define _MSC_CTRL_TIMEOUTFAULTEN_DEFAULT                                       \
  0x00000000UL /**< Mode DEFAULT for MSC_CTRL */
#define MSC_CTRL_TIMEOUTFAULTEN_DEFAULT                                        \
  (_MSC_CTRL_TIMEOUTFAULTEN_DEFAULT                                            \
   << 4) /**< Shifted mode DEFAULT for MSC_CTRL */

/* Bit fields for MSC READCTRL */
#define _MSC_READCTRL_RESETVALUE                                               \
  0x01000100UL /**< Default value for MSC_READCTRL */
...
#define _MSC_READCTRL_IFCDIS_DEFAULT                                           \
  0x00000000UL /**< Mode DEFAULT for MSC_READCTRL */
#define MSC_READCTRL_IFCDIS_DEFAULT                                            \
  (_MSC_READCTRL_IFCDIS_DEFAULT                                                \
   << 3) /**< Shifted mode DEFAULT for MSC_READCTRL */
...
#define _MSC_READCTRL_AIDIS_DEFAULT                                            \
  0x00000000UL /**< Mode DEFAULT for MSC_READCTRL */
#define MSC_READCTRL_AIDIS_DEFAULT                                             \
  (_MSC_READCTRL_AIDIS_DEFAULT                                                 \
   << 4) /**< Shifted mode DEFAULT for MSC_READCTRL */
...
#define _MSC_READCTRL_ICCDIS_DEFAULT                                           \
  0x00000000UL /**< Mode DEFAULT for MSC_READCTRL */
#define MSC_READCTRL_ICCDIS_DEFAULT                                            \
  (_MSC_READCTRL_ICCDIS_DEFAULT                                                \
   << 5) /**< Shifted mode DEFAULT for MSC_READCTRL */
...
#define _MSC_READCTRL_PREFETCH_DEFAULT                                         \
  0x00000001UL /**< Mode DEFAULT for MSC_READCTRL */
#define MSC_READCTRL_PREFETCH_DEFAULT                                          \
  (_MSC_READCTRL_PREFETCH_DEFAULT                                              \
   << 8) /**< Shifted mode DEFAULT for MSC_READCTRL */
...
#define _MSC_READCTRL_USEHPROT_DEFAULT                                         \
  0x00000000UL /**< Mode DEFAULT for MSC_READCTRL */
#define MSC_READCTRL_USEHPROT_DEFAULT                                          \
  (_MSC_READCTRL_USEHPROT_DEFAULT                                              \
   << 9) /**< Shifted mode DEFAULT for MSC_READCTRL */
...
#define _MSC_READCTRL_MODE_DEFAULT                                             \
  0x00000001UL /**< Mode DEFAULT for MSC_READCTRL */
...
#define MSC_READCTRL_MODE_WS0                                                  \
  (_MSC_READCTRL_MODE_WS0 << 24) /**< Shifted mode WS0 for MSC_READCTRL */
#define MSC_READCTRL_MODE_DEFAULT                                              \
  (_MSC_READCTRL_MODE_DEFAULT                                                  \
   << 24) /**< Shifted mode DEFAULT for MSC_READCTRL */
#define MSC_READCTRL_MODE_WS1                                                  \
  (_MSC_READCTRL_MODE_WS1 << 24) /**< Shifted mode WS1 for MSC_READCTRL */
#define MSC_READCTRL_MODE_WS2                                                  \
  (_MSC_READCTRL_MODE_WS2 << 24) /**< Shifted mode WS2 for MSC_READCTRL */
#define MSC_READCTRL_MODE_WS3                                                  \
  (_MSC_READCTRL_MODE_WS3 << 24) /**< Shifted mode WS3 for MSC_READCTRL */
#define MSC_READCTRL_SCBTP                                                     \
  (0x1UL << 28) /**< Suppress Conditional Branch Target Perfetch */
...
#define _MSC_READCTRL_SCBTP_DEFAULT                                            \
  0x00000000UL /**< Mode DEFAULT for MSC_READCTRL */
#define MSC_READCTRL_SCBTP_DEFAULT                                             \
  (_MSC_READCTRL_SCBTP_DEFAULT                                                 \
   << 28) /**< Shifted mode DEFAULT for MSC_READCTRL */

/* Bit fields for MSC WRITECTRL */
#define _MSC_WRITECTRL_RESETVALUE                                              \
  0x00000000UL /**< Default value for MSC_WRITECTRL */
...
#define _MSC_WRITECTRL_WREN_DEFAULT                                            \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECTRL */
#define MSC_WRITECTRL_WREN_DEFAULT                                             \
  (_MSC_WRITECTRL_WREN_DEFAULT                                                 \
   << 0) /**< Shifted mode DEFAULT for MSC_WRITECTRL */
#define MSC_WRITECTRL_IRQERASEABORT                                            \
  (0x1UL << 1) /**< Abort Page Erase on Interrupt */
#define _MSC_WRITECTRL_IRQERASEABORT_SHIFT                                     \
  1 /**< Shift value for MSC_IRQERASEABORT */
#define _MSC_WRITECTRL_IRQERASEABORT_MASK                                      \
  0x2UL /**< Bit mask for MSC_IRQERASEABORT */
#define _MSC_WRITECTRL_IRQERASEABORT_DEFAULT                                   \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECTRL */
#define MSC_WRITECTRL_IRQERASEABORT_DEFAULT                                    \
  (_MSC_WRITECTRL_IRQERASEABORT_DEFAULT                                        \
   << 1) /**< Shifted mode DEFAULT for MSC_WRITECTRL */
...
#define _MSC_WRITECTRL_RWWEN_DEFAULT                                           \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECTRL */
#define MSC_WRITECTRL_RWWEN_DEFAULT                                            \
  (_MSC_WRITECTRL_RWWEN_DEFAULT                                                \
   << 5) /**< Shifted mode DEFAULT for MSC_WRITECTRL */

/* Bit fields for MSC WRITECMD */
#define _MSC_WRITECMD_RESETVALUE                                               \
  0x00000000UL /**< Default value for MSC_WRITECMD */
...
#define _MSC_WRITECMD_LADDRIM_DEFAULT                                          \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECMD */
#define MSC_WRITECMD_LADDRIM_DEFAULT                                           \
  (_MSC_WRITECMD_LADDRIM_DEFAULT                                               \
   << 0) /**< Shifted mode DEFAULT for MSC_WRITECMD */
...
#define _MSC_WRITECMD_ERASEPAGE_DEFAULT                                        \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECMD */
#define MSC_WRITECMD_ERASEPAGE_DEFAULT                                         \
  (_MSC_WRITECMD_ERASEPAGE_DEFAULT                                             \
   << 1) /**< Shifted mode DEFAULT for MSC_WRITECMD */
...
#define _MSC_WRITECMD_WRITEEND_DEFAULT                                         \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECMD */
#define MSC_WRITECMD_WRITEEND_DEFAULT                                          \
  (_MSC_WRITECMD_WRITEEND_DEFAULT                                              \
   << 2) /**< Shifted mode DEFAULT for MSC_WRITECMD */
...
#define _MSC_WRITECMD_WRITEONCE_DEFAULT                                        \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECMD */
#define MSC_WRITECMD_WRITEONCE_DEFAULT                                         \
  (_MSC_WRITECMD_WRITEONCE_DEFAULT                                             \
   << 3) /**< Shifted mode DEFAULT for MSC_WRITECMD */
...
#define _MSC_WRITECMD_WRITETRIG_DEFAULT                                        \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECMD */
#define MSC_WRITECMD_WRITETRIG_DEFAULT                                         \
  (_MSC_WRITECMD_WRITETRIG_DEFAULT                                             \
   << 4) /**< Shifted mode DEFAULT for MSC_WRITECMD */
...
#define _MSC_WRITECMD_ERASEABORT_DEFAULT                                       \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECMD */
#define MSC_WRITECMD_ERASEABORT_DEFAULT                                        \
  (_MSC_WRITECMD_ERASEABORT_DEFAULT                                            \
   << 5) /**< Shifted mode DEFAULT for MSC_WRITECMD */
...
#define _MSC_WRITECMD_ERASEMAIN0_MASK                                          \
  0x100UL /**< Bit mask for MSC_ERASEMAIN0 */
#define _MSC_WRITECMD_ERASEMAIN0_DEFAULT                                       \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECMD */
#define MSC_WRITECMD_ERASEMAIN0_DEFAULT                                        \
  (_MSC_WRITECMD_ERASEMAIN0_DEFAULT                                            \
   << 8) /**< Shifted mode DEFAULT for MSC_WRITECMD */
...
#define _MSC_WRITECMD_ERASEMAIN1_MASK                                          \
  0x200UL /**< Bit mask for MSC_ERASEMAIN1 */
#define _MSC_WRITECMD_ERASEMAIN1_DEFAULT                                       \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECMD */
#define MSC_WRITECMD_ERASEMAIN1_DEFAULT                                        \
  (_MSC_WRITECMD_ERASEMAIN1_DEFAULT                                            \
   << 9) /**< Shifted mode DEFAULT for MSC_WRITECMD */
...
#define _MSC_WRITECMD_CLEARWDATA_MASK                                          \
  0x1000UL /**< Bit mask for MSC_CLEARWDATA */
#define _MSC_WRITECMD_CLEARWDATA_DEFAULT                                       \
  0x00000000UL /**< Mode DEFAULT for MSC_WRITECMD */
#define MSC_WRITECMD_CLEARWDATA_DEFAULT                                        \
  (_MSC_WRITECMD_CLEARWDATA_DEFAULT                                            \
   << 12) /**< Shifted mode DEFAULT for MSC_WRITECMD */
...
#define MSC_ADDRB_ADDRB_DEFAULT                                                \
  (_MSC_ADDRB_ADDRB_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_ADDRB */
...
#define MSC_WDATA_WDATA_DEFAULT                                                \
  (_MSC_WDATA_WDATA_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_WDATA */
...
#define _MSC_STATUS_BUSY_DEFAULT                                               \
  0x00000000UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_BUSY_DEFAULT                                                \
  (_MSC_STATUS_BUSY_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_STATUS */
...
#define _MSC_STATUS_LOCKED_DEFAULT                                             \
  0x00000000UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_LOCKED_DEFAULT                                              \
  (_MSC_STATUS_LOCKED_DEFAULT << 1) /**< Shifted mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_INVADDR                                                     \
  (0x1UL << 2)                      /**< Invalid Write Address or Erase Page */
...
#define _MSC_STATUS_INVADDR_DEFAULT                                            \
  0x00000000UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_INVADDR_DEFAULT                                             \
  (_MSC_STATUS_INVADDR_DEFAULT << 2) /**< Shifted mode DEFAULT for MSC_STATUS */
...
#define _MSC_STATUS_WDATAREADY_DEFAULT                                         \
  0x00000001UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_WDATAREADY_DEFAULT                                          \
  (_MSC_STATUS_WDATAREADY_DEFAULT                                              \
   << 3) /**< Shifted mode DEFAULT for MSC_STATUS */
...
#define _MSC_STATUS_WORDTIMEOUT_DEFAULT                                        \
  0x00000000UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_WORDTIMEOUT_DEFAULT                                         \
  (_MSC_STATUS_WORDTIMEOUT_DEFAULT                                             \
   << 4) /**< Shifted mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_ERASEABORTED                                                \
  (0x1UL << 5) /**< The Current Flash Erase Operation Aborted */
#define _MSC_STATUS_ERASEABORTED_SHIFT                                         \
  5 /**< Shift value for MSC_ERASEABORTED */
#define _MSC_STATUS_ERASEABORTED_MASK                                          \
  0x20UL /**< Bit mask for MSC_ERASEABORTED */
#define _MSC_STATUS_ERASEABORTED_DEFAULT                                       \
  0x00000000UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_ERASEABORTED_DEFAULT                                        \
  (_MSC_STATUS_ERASEABORTED_DEFAULT                                            \
   << 5) /**< Shifted mode DEFAULT for MSC_STATUS */
...
#define _MSC_STATUS_PCRUNNING_DEFAULT                                          \
  0x00000000UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_PCRUNNING_DEFAULT                                           \
  (_MSC_STATUS_PCRUNNING_DEFAULT                                               \
   << 6) /**< Shifted mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_BANKSWITCHED (0x1UL << 7) /**< BANK SWITCHING STATUS */
#define _MSC_STATUS_BANKSWITCHED_SHIFT                                         \
  7 /**< Shift value for MSC_BANKSWITCHED */
#define _MSC_STATUS_BANKSWITCHED_MASK                                          \
  0x80UL /**< Bit mask for MSC_BANKSWITCHED */
#define _MSC_STATUS_BANKSWITCHED_DEFAULT                                       \
  0x00000000UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_BANKSWITCHED_DEFAULT                                        \
  (_MSC_STATUS_BANKSWITCHED_DEFAULT                                            \
   << 7) /**< Shifted mode DEFAULT for MSC_STATUS */
#define _MSC_STATUS_WDATAVALID_SHIFT 24 /**< Shift value for MSC_WDATAVALID */
#define _MSC_STATUS_WDATAVALID_MASK                                            \
  0xF000000UL /**< Bit mask for MSC_WDATAVALID */
#define _MSC_STATUS_WDATAVALID_DEFAULT                                         \
  0x00000000UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_WDATAVALID_DEFAULT                                          \
  (_MSC_STATUS_WDATAVALID_DEFAULT                                              \
   << 24) /**< Shifted mode DEFAULT for MSC_STATUS */
#define _MSC_STATUS_PWRUPCKBDFAILCOUNT_SHIFT                                   \
  28 /**< Shift value for MSC_PWRUPCKBDFAILCOUNT */
#define _MSC_STATUS_PWRUPCKBDFAILCOUNT_MASK                                    \
  0xF0000000UL /**< Bit mask for MSC_PWRUPCKBDFAILCOUNT */
#define _MSC_STATUS_PWRUPCKBDFAILCOUNT_DEFAULT                                 \
  0x00000000UL /**< Mode DEFAULT for MSC_STATUS */
#define MSC_STATUS_PWRUPCKBDFAILCOUNT_DEFAULT                                  \
  (_MSC_STATUS_PWRUPCKBDFAILCOUNT_DEFAULT                                      \
   << 28) /**< Shifted mode DEFAULT for MSC_STATUS */
...
#define MSC_IF_ERASE_DEFAULT                                                   \
  (_MSC_IF_ERASE_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_IF */
...
#define MSC_IF_WRITE_DEFAULT                                                   \
  (_MSC_IF_WRITE_DEFAULT << 1) /**< Shifted mode DEFAULT for MSC_IF */
...
#define MSC_IF_CHOF_DEFAULT                                                    \
  (_MSC_IF_CHOF_DEFAULT << 2) /**< Shifted mode DEFAULT for MSC_IF */
...
#define MSC_IF_CMOF_DEFAULT                                                    \
  (_MSC_IF_CMOF_DEFAULT << 3) /**< Shifted mode DEFAULT for MSC_IF */
...
#define MSC_IF_PWRUPF_DEFAULT                                                  \
  (_MSC_IF_PWRUPF_DEFAULT << 4) /**< Shifted mode DEFAULT for MSC_IF */
...
#define MSC_IF_ICACHERR_DEFAULT                                                \
  (_MSC_IF_ICACHERR_DEFAULT << 5) /**< Shifted mode DEFAULT for MSC_IF */
#define MSC_IF_WDATAOV                                                         \
  (0x1UL << 6)                    /**< Flash Controller Write Buffer Overflow */
...
#define MSC_IF_WDATAOV_DEFAULT                                                 \
  (_MSC_IF_WDATAOV_DEFAULT << 6) /**< Shifted mode DEFAULT for MSC_IF */
...
#define MSC_IF_LVEWRITE_DEFAULT                                                \
  (_MSC_IF_LVEWRITE_DEFAULT << 8) /**< Shifted mode DEFAULT for MSC_IF */
...
#define MSC_IFS_ERASE_DEFAULT                                                  \
  (_MSC_IFS_ERASE_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_IFS */
...
#define MSC_IFS_WRITE_DEFAULT                                                  \
  (_MSC_IFS_WRITE_DEFAULT << 1) /**< Shifted mode DEFAULT for MSC_IFS */
...
#define MSC_IFS_CMOF_DEFAULT                                                   \
  (_MSC_IFS_CMOF_DEFAULT << 3) /**< Shifted mode DEFAULT for MSC_IFS */
...
#define MSC_IFS_PWRUPF_DEFAULT                                                 \
  (_MSC_IFS_PWRUPF_DEFAULT << 4) /**< Shifted mode DEFAULT for MSC_IFS */
...
#define MSC_IFS_WDATAOV_DEFAULT                                                \
  (_MSC_IFS_WDATAOV_DEFAULT << 6) /**< Shifted mode DEFAULT for MSC_IFS */
...
#define MSC_IFS_LVEWRITE_DEFAULT                                               \
  (_MSC_IFS_LVEWRITE_DEFAULT << 8) /**< Shifted mode DEFAULT for MSC_IFS */
...
#define MSC_IFC_ERASE_DEFAULT                                                  \
  (_MSC_IFC_ERASE_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_IFC */
...
#define MSC_IFC_WRITE_DEFAULT                                                  \
  (_MSC_IFC_WRITE_DEFAULT << 1) /**< Shifted mode DEFAULT for MSC_IFC */
...
#define MSC_IFC_CHOF_DEFAULT                                                   \
  (_MSC_IFC_CHOF_DEFAULT << 2) /**< Shifted mode DEFAULT for MSC_IFC */
...
#define MSC_IFC_CMOF_DEFAULT                                                   \
  (_MSC_IFC_CMOF_DEFAULT << 3) /**< Shifted mode DEFAULT for MSC_IFC */
...
#define MSC_IFC_PWRUPF_DEFAULT                                                 \
  (_MSC_IFC_PWRUPF_DEFAULT << 4) /**< Shifted mode DEFAULT for MSC_IFC */
...
#define MSC_IFC_ICACHERR_DEFAULT                                               \
  (_MSC_IFC_ICACHERR_DEFAULT << 5) /**< Shifted mode DEFAULT for MSC_IFC */
...
#define MSC_IFC_WDATAOV_DEFAULT                                                \
  (_MSC_IFC_WDATAOV_DEFAULT << 6) /**< Shifted mode DEFAULT for MSC_IFC */
...
#define MSC_IFC_LVEWRITE_DEFAULT                                               \
  (_MSC_IFC_LVEWRITE_DEFAULT << 8) /**< Shifted mode DEFAULT for MSC_IFC */
...
#define MSC_IEN_ERASE_DEFAULT                                                  \
  (_MSC_IEN_ERASE_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_IEN */
...
#define MSC_IEN_WRITE_DEFAULT                                                  \
  (_MSC_IEN_WRITE_DEFAULT << 1) /**< Shifted mode DEFAULT for MSC_IEN */
...
#define MSC_IEN_CHOF_DEFAULT                                                   \
  (_MSC_IEN_CHOF_DEFAULT << 2) /**< Shifted mode DEFAULT for MSC_IEN */
...
#define MSC_IEN_CMOF_DEFAULT                                                   \
  (_MSC_IEN_CMOF_DEFAULT << 3) /**< Shifted mode DEFAULT for MSC_IEN */
...
#define MSC_IEN_PWRUPF_DEFAULT                                                 \
  (_MSC_IEN_PWRUPF_DEFAULT << 4) /**< Shifted mode DEFAULT for MSC_IEN */
...
#define MSC_IEN_ICACHERR_DEFAULT                                               \
  (_MSC_IEN_ICACHERR_DEFAULT << 5) /**< Shifted mode DEFAULT for MSC_IEN */
...
#define MSC_IEN_WDATAOV_DEFAULT                                                \
  (_MSC_IEN_WDATAOV_DEFAULT << 6) /**< Shifted mode DEFAULT for MSC_IEN */
...
#define MSC_IEN_LVEWRITE_DEFAULT                                               \
  (_MSC_IEN_LVEWRITE_DEFAULT << 8) /**< Shifted mode DEFAULT for MSC_IEN */
...
#define _MSC_LOCK_LOCKKEY_UNLOCKED                                             \
  0x00000000UL                                /**< Mode UNLOCKED for MSC_LOCK */
...
#define MSC_LOCK_LOCKKEY_DEFAULT                                               \
  (_MSC_LOCK_LOCKKEY_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_LOCK */
#define MSC_LOCK_LOCKKEY_UNLOCKED                                              \
  (_MSC_LOCK_LOCKKEY_UNLOCKED << 0) /**< Shifted mode UNLOCKED for MSC_LOCK */
#define MSC_LOCK_LOCKKEY_LOCK                                                  \
  (_MSC_LOCK_LOCKKEY_LOCK << 0) /**< Shifted mode LOCK for MSC_LOCK */
#define MSC_LOCK_LOCKKEY_LOCKED                                                \
  (_MSC_LOCK_LOCKKEY_LOCKED << 0) /**< Shifted mode LOCKED for MSC_LOCK */
#define MSC_LOCK_LOCKKEY_UNLOCK                                                \
  (_MSC_LOCK_LOCKKEY_UNLOCK << 0) /**< Shifted mode UNLOCK for MSC_LOCK */

/* Bit fields for MSC CACHECMD */
#define _MSC_CACHECMD_RESETVALUE                                               \
  0x00000000UL /**< Default value for MSC_CACHECMD */
...
#define _MSC_CACHECMD_INVCACHE_DEFAULT                                         \
  0x00000000UL /**< Mode DEFAULT for MSC_CACHECMD */
#define MSC_CACHECMD_INVCACHE_DEFAULT                                          \
  (_MSC_CACHECMD_INVCACHE_DEFAULT                                              \
   << 0) /**< Shifted mode DEFAULT for MSC_CACHECMD */
...
#define _MSC_CACHECMD_STARTPC_DEFAULT                                          \
  0x00000000UL /**< Mode DEFAULT for MSC_CACHECMD */
#define MSC_CACHECMD_STARTPC_DEFAULT                                           \
  (_MSC_CACHECMD_STARTPC_DEFAULT                                               \
   << 1) /**< Shifted mode DEFAULT for MSC_CACHECMD */
...
#define _MSC_CACHECMD_STOPPC_DEFAULT                                           \
  0x00000000UL /**< Mode DEFAULT for MSC_CACHECMD */
#define MSC_CACHECMD_STOPPC_DEFAULT                                            \
  (_MSC_CACHECMD_STOPPC_DEFAULT                                                \
   << 2) /**< Shifted mode DEFAULT for MSC_CACHECMD */

/* Bit fields for MSC CACHEHITS */
#define _MSC_CACHEHITS_RESETVALUE                                              \
  0x00000000UL /**< Default value for MSC_CACHEHITS */
...
#define _MSC_CACHEHITS_CACHEHITS_MASK                                          \
  0xFFFFFUL /**< Bit mask for MSC_CACHEHITS */
#define _MSC_CACHEHITS_CACHEHITS_DEFAULT                                       \
  0x00000000UL /**< Mode DEFAULT for MSC_CACHEHITS */
#define MSC_CACHEHITS_CACHEHITS_DEFAULT                                        \
  (_MSC_CACHEHITS_CACHEHITS_DEFAULT                                            \
   << 0) /**< Shifted mode DEFAULT for MSC_CACHEHITS */

/* Bit fields for MSC CACHEMISSES */
#define _MSC_CACHEMISSES_RESETVALUE                                            \
  0x00000000UL /**< Default value for MSC_CACHEMISSES */
#define _MSC_CACHEMISSES_MASK 0x000FFFFFUL /**< Mask for MSC_CACHEMISSES */
#define _MSC_CACHEMISSES_CACHEMISSES_SHIFT                                     \
  0 /**< Shift value for MSC_CACHEMISSES */
#define _MSC_CACHEMISSES_CACHEMISSES_MASK                                      \
  0xFFFFFUL /**< Bit mask for MSC_CACHEMISSES */
#define _MSC_CACHEMISSES_CACHEMISSES_DEFAULT                                   \
  0x00000000UL /**< Mode DEFAULT for MSC_CACHEMISSES */
#define MSC_CACHEMISSES_CACHEMISSES_DEFAULT                                    \
  (_MSC_CACHEMISSES_CACHEMISSES_DEFAULT                                        \
   << 0) /**< Shifted mode DEFAULT for MSC_CACHEMISSES */

/* Bit fields for MSC MASSLOCK */
#define _MSC_MASSLOCK_RESETVALUE                                               \
  0x00000001UL /**< Default value for MSC_MASSLOCK */
...
#define _MSC_MASSLOCK_LOCKKEY_UNLOCKED                                         \
  0x00000000UL /**< Mode UNLOCKED for MSC_MASSLOCK */
#define _MSC_MASSLOCK_LOCKKEY_LOCK                                             \
  0x00000000UL /**< Mode LOCK for MSC_MASSLOCK */
#define _MSC_MASSLOCK_LOCKKEY_DEFAULT                                          \
  0x00000001UL /**< Mode DEFAULT for MSC_MASSLOCK */
#define _MSC_MASSLOCK_LOCKKEY_LOCKED                                           \
  0x00000001UL /**< Mode LOCKED for MSC_MASSLOCK */
#define _MSC_MASSLOCK_LOCKKEY_UNLOCK                                           \
  0x0000631AUL /**< Mode UNLOCK for MSC_MASSLOCK */
#define MSC_MASSLOCK_LOCKKEY_UNLOCKED                                          \
  (_MSC_MASSLOCK_LOCKKEY_UNLOCKED                                              \
   << 0) /**< Shifted mode UNLOCKED for MSC_MASSLOCK */
#define MSC_MASSLOCK_LOCKKEY_LOCK                                              \
  (_MSC_MASSLOCK_LOCKKEY_LOCK << 0) /**< Shifted mode LOCK for MSC_MASSLOCK */
#define MSC_MASSLOCK_LOCKKEY_DEFAULT                                           \
  (_MSC_MASSLOCK_LOCKKEY_DEFAULT                                               \
   << 0) /**< Shifted mode DEFAULT for MSC_MASSLOCK */
#define MSC_MASSLOCK_LOCKKEY_LOCKED                                            \
  (_MSC_MASSLOCK_LOCKKEY_LOCKED                                                \
   << 0) /**< Shifted mode LOCKED for MSC_MASSLOCK */
#define MSC_MASSLOCK_LOCKKEY_UNLOCK                                            \
  (_MSC_MASSLOCK_LOCKKEY_UNLOCK                                                \
   << 0) /**< Shifted mode UNLOCK for MSC_MASSLOCK */

/* Bit fields for MSC STARTUP */
#define _MSC_STARTUP_RESETVALUE                                                \
  0x1300104DUL /**< Default value for MSC_STARTUP */
...
#define _MSC_STARTUP_STDLY0_DEFAULT                                            \
  0x0000004DUL /**< Mode DEFAULT for MSC_STARTUP */
#define MSC_STARTUP_STDLY0_DEFAULT                                             \
  (_MSC_STARTUP_STDLY0_DEFAULT                                                 \
   << 0) /**< Shifted mode DEFAULT for MSC_STARTUP */
...
#define _MSC_STARTUP_STDLY1_DEFAULT                                            \
  0x00000001UL /**< Mode DEFAULT for MSC_STARTUP */
#define MSC_STARTUP_STDLY1_DEFAULT                                             \
  (_MSC_STARTUP_STDLY1_DEFAULT                                                 \
   << 12) /**< Shifted mode DEFAULT for MSC_STARTUP */
...
#define _MSC_STARTUP_ASTWAIT_DEFAULT                                           \
  0x00000001UL /**< Mode DEFAULT for MSC_STARTUP */
#define MSC_STARTUP_ASTWAIT_DEFAULT                                            \
  (_MSC_STARTUP_ASTWAIT_DEFAULT                                                \
   << 24) /**< Shifted mode DEFAULT for MSC_STARTUP */
...
#define _MSC_STARTUP_STWSEN_DEFAULT                                            \
  0x00000001UL /**< Mode DEFAULT for MSC_STARTUP */
#define MSC_STARTUP_STWSEN_DEFAULT                                             \
  (_MSC_STARTUP_STWSEN_DEFAULT                                                 \
   << 25) /**< Shifted mode DEFAULT for MSC_STARTUP */
#define MSC_STARTUP_STWSAEN                                                    \
  (0x1UL << 26)                       /**< Startup Waitstates Always Enable */
...
#define _MSC_STARTUP_STWSAEN_DEFAULT                                           \
  0x00000000UL /**< Mode DEFAULT for MSC_STARTUP */
#define MSC_STARTUP_STWSAEN_DEFAULT                                            \
  (_MSC_STARTUP_STWSAEN_DEFAULT                                                \
   << 26)                          /**< Shifted mode DEFAULT for MSC_STARTUP */
...
#define _MSC_STARTUP_STWS_DEFAULT                                              \
  0x00000001UL /**< Mode DEFAULT for MSC_STARTUP */
#define MSC_STARTUP_STWS_DEFAULT                                               \
  (_MSC_STARTUP_STWS_DEFAULT << 28) /**< Shifted mode DEFAULT for MSC_STARTUP */

/* Bit fields for MSC BANKSWITCHLOCK */
#define _MSC_BANKSWITCHLOCK_RESETVALUE                                         \
  0x00000001UL /**< Default value for MSC_BANKSWITCHLOCK */
#define _MSC_BANKSWITCHLOCK_MASK                                               \
  0x0000FFFFUL /**< Mask for MSC_BANKSWITCHLOCK */
#define _MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_SHIFT                            \
  0 /**< Shift value for MSC_BANKSWITCHLOCKKEY */
#define _MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_MASK                             \
  0xFFFFUL /**< Bit mask for MSC_BANKSWITCHLOCKKEY */
#define _MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_UNLOCKED                         \
  0x00000000UL /**< Mode UNLOCKED for MSC_BANKSWITCHLOCK */
#define _MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_LOCK                             \
  0x00000000UL /**< Mode LOCK for MSC_BANKSWITCHLOCK */
#define _MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_DEFAULT                          \
  0x00000001UL /**< Mode DEFAULT for MSC_BANKSWITCHLOCK */
#define _MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_LOCKED                           \
  0x00000001UL /**< Mode LOCKED for MSC_BANKSWITCHLOCK */
#define _MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_UNLOCK                           \
  0x00007C2BUL /**< Mode UNLOCK for MSC_BANKSWITCHLOCK */
#define MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_UNLOCKED                          \
  (_MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_UNLOCKED                              \
   << 0) /**< Shifted mode UNLOCKED for MSC_BANKSWITCHLOCK */
#define MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_LOCK                              \
  (_MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_LOCK                                  \
   << 0) /**< Shifted mode LOCK for MSC_BANKSWITCHLOCK */
#define MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_DEFAULT                           \
  (_MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_DEFAULT                               \
   << 0) /**< Shifted mode DEFAULT for MSC_BANKSWITCHLOCK */
#define MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_LOCKED                            \
  (_MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_LOCKED                                \
   << 0) /**< Shifted mode LOCKED for MSC_BANKSWITCHLOCK */
#define MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_UNLOCK                            \
  (_MSC_BANKSWITCHLOCK_BANKSWITCHLOCKKEY_UNLOCK                                \
   << 0) /**< Shifted mode UNLOCK for MSC_BANKSWITCHLOCK */
...
#define MSC_CMD_PWRUP_DEFAULT                                                  \
  (_MSC_CMD_PWRUP_DEFAULT << 0) /**< Shifted mode DEFAULT for MSC_CMD */
...
#define _MSC_CMD_SWITCHINGBANK_DEFAULT                                         \
  0x00000000UL /**< Mode DEFAULT for MSC_CMD */
#define MSC_CMD_SWITCHINGBANK_DEFAULT                                          \
  (_MSC_CMD_SWITCHINGBANK_DEFAULT << 1) /**< Shifted mode DEFAULT for MSC_CMD */

/* Bit fields for MSC BOOTLOADERCTRL */
#define _MSC_BOOTLOADERCTRL_RESETVALUE                                         \
  0x00000000UL /**< Default value for MSC_BOOTLOADERCTRL */
#define _MSC_BOOTLOADERCTRL_MASK                                               \
  0x00000003UL /**< Mask for MSC_BOOTLOADERCTRL */
#define MSC_BOOTLOADERCTRL_BLRDIS                                              \
  (0x1UL << 0)                             /**< Flash Bootloader Read Disable */
...
#define _MSC_BOOTLOADERCTRL_BLRDIS_DEFAULT                                     \
  0x00000000UL /**< Mode DEFAULT for MSC_BOOTLOADERCTRL */
#define MSC_BOOTLOADERCTRL_BLRDIS_DEFAULT                                      \
  (_MSC_BOOTLOADERCTRL_BLRDIS_DEFAULT                                          \
   << 0) /**< Shifted mode DEFAULT for MSC_BOOTLOADERCTRL */
#define MSC_BOOTLOADERCTRL_BLWDIS                                              \
  (0x1UL << 1) /**< Flash Bootloader Write/Erase Disable */
...
#define _MSC_BOOTLOADERCTRL_BLWDIS_DEFAULT                                     \
  0x00000000UL /**< Mode DEFAULT for MSC_BOOTLOADERCTRL */
#define MSC_BOOTLOADERCTRL_BLWDIS_DEFAULT                                      \
  (_MSC_BOOTLOADERCTRL_BLWDIS_DEFAULT                                          \
   << 1) /**< Shifted mode DEFAULT for MSC_BOOTLOADERCTRL */

/* Bit fields for MSC AAPUNLOCKCMD */
#define _MSC_AAPUNLOCKCMD_RESETVALUE                                           \
  0x00000000UL /**< Default value for MSC_AAPUNLOCKCMD */
#define _MSC_AAPUNLOCKCMD_MASK 0x00000001UL /**< Mask for MSC_AAPUNLOCKCMD */
#define MSC_AAPUNLOCKCMD_UNLOCKAAP                                             \
  (0x1UL << 0) /**< Software Unlock AAP Command */
#define _MSC_AAPUNLOCKCMD_UNLOCKAAP_SHIFT                                      \
  0 /**< Shift value for MSC_UNLOCKAAP */
#define _MSC_AAPUNLOCKCMD_UNLOCKAAP_MASK                                       \
  0x1UL /**< Bit mask for MSC_UNLOCKAAP */
#define _MSC_AAPUNLOCKCMD_UNLOCKAAP_DEFAULT                                    \
  0x00000000UL /**< Mode DEFAULT for MSC_AAPUNLOCKCMD */
#define MSC_AAPUNLOCKCMD_UNLOCKAAP_DEFAULT                                     \
  (_MSC_AAPUNLOCKCMD_UNLOCKAAP_DEFAULT                                         \
   << 0) /**< Shifted mode DEFAULT for MSC_AAPUNLOCKCMD */

/* Bit fields for MSC CACHECONFIG0 */
#define _MSC_CACHECONFIG0_RESETVALUE                                           \
  0x00000003UL /**< Default value for MSC_CACHECONFIG0 */
#define _MSC_CACHECONFIG0_MASK 0x00000003UL /**< Mask for MSC_CACHECONFIG0 */
#define _MSC_CACHECONFIG0_CACHELPLEVEL_SHIFT                                   \
  0 /**< Shift value for MSC_CACHELPLEVEL */
#define _MSC_CACHECONFIG0_CACHELPLEVEL_MASK                                    \
  0x3UL /**< Bit mask for MSC_CACHELPLEVEL */
#define _MSC_CACHECONFIG0_CACHELPLEVEL_BASE                                    \
  0x00000000UL /**< Mode BASE for MSC_CACHECONFIG0 */
#define _MSC_CACHECONFIG0_CACHELPLEVEL_ADVANCED                                \
  0x00000001UL /**< Mode ADVANCED for MSC_CACHECONFIG0 */
#define _MSC_CACHECONFIG0_CACHELPLEVEL_DEFAULT                                 \
  0x00000003UL /**< Mode DEFAULT for MSC_CACHECONFIG0 */
#define _MSC_CACHECONFIG0_CACHELPLEVEL_MINACTIVITY                             \
  0x00000003UL /**< Mode MINACTIVITY for MSC_CACHECONFIG0 */
#define MSC_CACHECONFIG0_CACHELPLEVEL_BASE                                     \
  (_MSC_CACHECONFIG0_CACHELPLEVEL_BASE                                         \
   << 0) /**< Shifted mode BASE for MSC_CACHECONFIG0 */
#define MSC_CACHECONFIG0_CACHELPLEVEL_ADVANCED                                 \
  (_MSC_CACHECONFIG0_CACHELPLEVEL_ADVANCED                                     \
   << 0) /**< Shifted mode ADVANCED for MSC_CACHECONFIG0 */
#define MSC_CACHECONFIG0_CACHELPLEVEL_DEFAULT                                  \
  (_MSC_CACHECONFIG0_CACHELPLEVEL_DEFAULT                                      \
   << 0) /**< Shifted mode DEFAULT for MSC_CACHECONFIG0 */
#define MSC_CACHECONFIG0_CACHELPLEVEL_MINACTIVITY                              \
  (_MSC_CACHECONFIG0_CACHELPLEVEL_MINACTIVITY                                  \
   << 0) /**< Shifted mode MINACTIVITY for MSC_CACHECONFIG0 */

/* Bit fields for MSC RAMCTRL */
#define _MSC_RAMCTRL_RESETVALUE                                                \
  0x00000000UL /**< Default value for MSC_RAMCTRL */
...
#define _MSC_RAMCTRL_RAMCACHEEN_DEFAULT                                        \
  0x00000000UL /**< Mode DEFAULT for MSC_RAMCTRL */
#define MSC_RAMCTRL_RAMCACHEEN_DEFAULT                                         \
  (_MSC_RAMCTRL_RAMCACHEEN_DEFAULT                                             \
   << 0) /**< Shifted mode DEFAULT for MSC_RAMCTRL */
...
#define _MSC_RAMCTRL_RAM1CACHEEN_MASK                                          \
  0x100UL /**< Bit mask for MSC_RAM1CACHEEN */
#define _MSC_RAMCTRL_RAM1CACHEEN_DEFAULT                                       \
  0x00000000UL /**< Mode DEFAULT for MSC_RAMCTRL */
#define MSC_RAMCTRL_RAM1CACHEEN_DEFAULT                                        \
  (_MSC_RAMCTRL_RAM1CACHEEN_DEFAULT                                            \
   << 8) /**< Shifted mode DEFAULT for MSC_RAMCTRL */
