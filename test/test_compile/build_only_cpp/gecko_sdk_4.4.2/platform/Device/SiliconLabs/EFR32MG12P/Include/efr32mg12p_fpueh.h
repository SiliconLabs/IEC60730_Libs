...
#define FPUEH_IF_FPIOC_DEFAULT                                                 \
  (_FPUEH_IF_FPIOC_DEFAULT << 0) /**< Shifted mode DEFAULT for FPUEH_IF */
...
#define FPUEH_IF_FPDZC_DEFAULT                                                 \
  (_FPUEH_IF_FPDZC_DEFAULT << 1) /**< Shifted mode DEFAULT for FPUEH_IF */
...
#define FPUEH_IF_FPUFC_DEFAULT                                                 \
  (_FPUEH_IF_FPUFC_DEFAULT << 2) /**< Shifted mode DEFAULT for FPUEH_IF */
...
#define FPUEH_IF_FPOFC_DEFAULT                                                 \
  (_FPUEH_IF_FPOFC_DEFAULT << 3) /**< Shifted mode DEFAULT for FPUEH_IF */
...
#define FPUEH_IF_FPIDC_DEFAULT                                                 \
  (_FPUEH_IF_FPIDC_DEFAULT << 4) /**< Shifted mode DEFAULT for FPUEH_IF */
...
#define FPUEH_IF_FPIXC_DEFAULT                                                 \
  (_FPUEH_IF_FPIXC_DEFAULT << 5) /**< Shifted mode DEFAULT for FPUEH_IF */
...
#define FPUEH_IFS_FPIOC_DEFAULT                                                \
  (_FPUEH_IFS_FPIOC_DEFAULT << 0) /**< Shifted mode DEFAULT for FPUEH_IFS */
...
#define FPUEH_IFS_FPDZC_DEFAULT                                                \
  (_FPUEH_IFS_FPDZC_DEFAULT << 1) /**< Shifted mode DEFAULT for FPUEH_IFS */
...
#define FPUEH_IFS_FPUFC_DEFAULT                                                \
  (_FPUEH_IFS_FPUFC_DEFAULT << 2) /**< Shifted mode DEFAULT for FPUEH_IFS */
...
#define FPUEH_IFS_FPOFC_DEFAULT                                                \
  (_FPUEH_IFS_FPOFC_DEFAULT << 3) /**< Shifted mode DEFAULT for FPUEH_IFS */
...
#define FPUEH_IFS_FPIDC_DEFAULT                                                \
  (_FPUEH_IFS_FPIDC_DEFAULT << 4) /**< Shifted mode DEFAULT for FPUEH_IFS */
...
#define FPUEH_IFS_FPIXC_DEFAULT                                                \
  (_FPUEH_IFS_FPIXC_DEFAULT << 5) /**< Shifted mode DEFAULT for FPUEH_IFS */
...
#define FPUEH_IFC_FPIOC_DEFAULT                                                \
  (_FPUEH_IFC_FPIOC_DEFAULT << 0) /**< Shifted mode DEFAULT for FPUEH_IFC */
...
#define FPUEH_IFC_FPDZC_DEFAULT                                                \
  (_FPUEH_IFC_FPDZC_DEFAULT << 1) /**< Shifted mode DEFAULT for FPUEH_IFC */
...
#define FPUEH_IFC_FPUFC_DEFAULT                                                \
  (_FPUEH_IFC_FPUFC_DEFAULT << 2) /**< Shifted mode DEFAULT for FPUEH_IFC */
...
#define FPUEH_IFC_FPOFC_DEFAULT                                                \
  (_FPUEH_IFC_FPOFC_DEFAULT << 3) /**< Shifted mode DEFAULT for FPUEH_IFC */
...
#define FPUEH_IFC_FPIDC_DEFAULT                                                \
  (_FPUEH_IFC_FPIDC_DEFAULT << 4) /**< Shifted mode DEFAULT for FPUEH_IFC */
...
#define FPUEH_IFC_FPIXC_DEFAULT                                                \
  (_FPUEH_IFC_FPIXC_DEFAULT << 5) /**< Shifted mode DEFAULT for FPUEH_IFC */
...
#define FPUEH_IEN_FPIOC_DEFAULT                                                \
  (_FPUEH_IEN_FPIOC_DEFAULT << 0) /**< Shifted mode DEFAULT for FPUEH_IEN */
...
#define FPUEH_IEN_FPDZC_DEFAULT                                                \
  (_FPUEH_IEN_FPDZC_DEFAULT << 1) /**< Shifted mode DEFAULT for FPUEH_IEN */
...
#define FPUEH_IEN_FPUFC_DEFAULT                                                \
  (_FPUEH_IEN_FPUFC_DEFAULT << 2) /**< Shifted mode DEFAULT for FPUEH_IEN */
...
#define FPUEH_IEN_FPOFC_DEFAULT                                                \
  (_FPUEH_IEN_FPOFC_DEFAULT << 3) /**< Shifted mode DEFAULT for FPUEH_IEN */
...
#define FPUEH_IEN_FPIDC_DEFAULT                                                \
  (_FPUEH_IEN_FPIDC_DEFAULT << 4) /**< Shifted mode DEFAULT for FPUEH_IEN */
...
#define FPUEH_IEN_FPIXC_DEFAULT                                                \
  (_FPUEH_IEN_FPIXC_DEFAULT << 5) /**< Shifted mode DEFAULT for FPUEH_IEN */
