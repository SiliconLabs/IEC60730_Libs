...
#define SL_MX25_FLASH_SHUTDOWN_CLK                                             \
...
#else
  SL_MX25_FLASH_SHUTDOWN_PERIPHERAL->ROUTELOC0 =
      ((SL_MX25_FLASH_SHUTDOWN_RX_LOC << _USART_ROUTELOC0_RXLOC_SHIFT)
       | (SL_MX25_FLASH_SHUTDOWN_TX_LOC << _USART_ROUTELOC0_TXLOC_SHIFT)
       | (SL_MX25_FLASH_SHUTDOWN_CLK_LOC << _USART_ROUTELOC0_CLKLOC_SHIFT));
  SL_MX25_FLASH_SHUTDOWN_PERIPHERAL->ROUTEPEN =
