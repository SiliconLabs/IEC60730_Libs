...
#if defined(_SILICON_LABS_32B_SERIES_3)
  sl_gpio_set_pin_mode(SL_BOARD_ENABLE_VCOM_PORT,
                       SL_BOARD_ENABLE_VCOM_PIN,
                       SL_GPIO_MODE_PUSH_PULL,
                       1);
#else
  GPIO_PinModeSet(SL_BOARD_ENABLE_VCOM_PORT,
                  SL_BOARD_ENABLE_VCOM_PIN,
                  gpioModePushPull,
                  1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
  sl_gpio_set_pin_mode(SL_BOARD_ENABLE_DISPLAY_PORT,
                       SL_BOARD_ENABLE_DISPLAY_PIN,
                       SL_GPIO_MODE_PUSH_PULL,
                       1);
#else
  GPIO_PinModeSet(SL_BOARD_ENABLE_DISPLAY_PORT,
                  SL_BOARD_ENABLE_DISPLAY_PIN,
                  gpioModePushPull,
                  1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
  sl_gpio_set_pin_mode(SL_BOARD_SELECT_DISPLAY_PORT,
                       SL_BOARD_SELECT_DISPLAY_PIN,
                       SL_GPIO_MODE_PUSH_PULL,
                       1);
#else
  GPIO_PinModeSet(SL_BOARD_SELECT_DISPLAY_PORT,
                  SL_BOARD_SELECT_DISPLAY_PIN,
                  gpioModePushPull,
                  1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_SENSOR_RHT_PORT,
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_SENSOR_LIGHT_PORT,
                           SL_BOARD_ENABLE_SENSOR_LIGHT_PIN,
                           SL_GPIO_MODE_PUSH_PULL,
                           1);
#else
      GPIO_PinModeSet(SL_BOARD_ENABLE_SENSOR_LIGHT_PORT,
                      SL_BOARD_ENABLE_SENSOR_LIGHT_PIN,
                      gpioModePushPull,
                      1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_SENSOR_PRESSURE_PORT,
                           SL_BOARD_ENABLE_SENSOR_PRESSURE_PIN,
                           SL_GPIO_MODE_PUSH_PULL,
                           1);
#else
      GPIO_PinModeSet(SL_BOARD_ENABLE_SENSOR_PRESSURE_PORT,
                      SL_BOARD_ENABLE_SENSOR_PRESSURE_PIN,
                      gpioModePushPull,
                      1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_SENSOR_HALL_PORT,
                           SL_BOARD_ENABLE_SENSOR_HALL_PIN,
                           SL_GPIO_MODE_PUSH_PULL,
                           1);
#else
      GPIO_PinModeSet(SL_BOARD_ENABLE_SENSOR_HALL_PORT,
                      SL_BOARD_ENABLE_SENSOR_HALL_PIN,
                      gpioModePushPull,
                      1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_SENSOR_GAS_PORT,
                           SL_BOARD_ENABLE_SENSOR_GAS_PIN,
                           SL_GPIO_MODE_PUSH_PULL,
                           1);
#else
      GPIO_PinModeSet(SL_BOARD_ENABLE_SENSOR_GAS_PORT,
                      SL_BOARD_ENABLE_SENSOR_GAS_PIN,
                      gpioModePushPull,
                      1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_SENSOR_IMU_PORT,
                           SL_BOARD_ENABLE_SENSOR_IMU_PIN,
                           SL_GPIO_MODE_PUSH_PULL,
                           1);
#else
      GPIO_PinModeSet(SL_BOARD_ENABLE_SENSOR_IMU_PORT,
                      SL_BOARD_ENABLE_SENSOR_IMU_PIN,
                      gpioModePushPull,
                      1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_SENSOR_MICROPHONE_PORT,
                           SL_BOARD_ENABLE_SENSOR_MICROPHONE_PIN,
                           SL_GPIO_MODE_PUSH_PULL,
                           1);
#else
      GPIO_PinModeSet(SL_BOARD_ENABLE_SENSOR_MICROPHONE_PORT,
                      SL_BOARD_ENABLE_SENSOR_MICROPHONE_PIN,
                      gpioModePushPull,
                      1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_MEMORY_SDCARD_PORT,
                           SL_BOARD_ENABLE_MEMORY_SDCARD_PIN,
                           SL_GPIO_MODE_PUSH_PULL,
                           0);
#else
      GPIO_PinModeSet(SL_BOARD_ENABLE_MEMORY_SDCARD_PORT,
                      SL_BOARD_ENABLE_MEMORY_SDCARD_PIN,
                      gpioModePushPull,
                      1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_MEMORY_QSPI_PORT,
                           SL_BOARD_ENABLE_MEMORY_QSPI_PIN,
                           SL_GPIO_MODE_PUSH_PULL,
                           0);
#else
      GPIO_PinModeSet(SL_BOARD_ENABLE_MEMORY_QSPI_PORT,
                      SL_BOARD_ENABLE_MEMORY_QSPI_PIN,
                      gpioModePushPull,
                      1);
#endif
...
#if defined(_SILICON_LABS_32B_SERIES_3)
      sl_gpio_set_pin_mode(SL_BOARD_ENABLE_OSCILLATOR_TCXO_PORT,
                           SL_BOARD_ENABLE_OSCILLATOR_TCXO_PIN,
                           SL_GPIO_MODE_PUSH_PULL,
                           1);
#else
      GPIO_PinModeSet(SL_BOARD_ENABLE_OSCILLATOR_TCXO_PORT,
                      SL_BOARD_ENABLE_OSCILLATOR_TCXO_PIN,
                      gpioModePushPull,
                      1);
#endif
