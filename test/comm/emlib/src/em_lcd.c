...
#endif
                | _LCD_DISPCTRL_MUX_MASK | _LCD_DISPCTRL_BIAS_MASK
...
void LCD_FrameCountInit(const LCD_FrameCountInit_TypeDef *fcInit)
{
  ...
  bacfg &= ~(_LCD_BACFG_FCTOP_MASK | _LCD_BACFG_FCPRESC_MASK);
  ...
  /* Reconfigure the frame count configuration. */
  bactrl &= ~(_LCD_BACTRL_FCTOP_MASK | _LCD_BACTRL_FCPRESC_MASK);
...
void LCD_AnimInit(const LCD_AnimInit_TypeDef *animInit)
{
  ...
  bactrl &= ~(_LCD_BACTRL_AREGASC_MASK | _LCD_BACTRL_AREGBSC_MASK
