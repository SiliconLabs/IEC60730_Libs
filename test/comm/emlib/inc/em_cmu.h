...
typedef enum {
  ...
  cmuClock_SYSCLK =
      (CMU_SYSCLK_BRANCH << CMU_CLK_BRANCH_POS), /**< SYSTEM clock. */
  cmuClock_SYSTICK =
      (CMU_SYSTICK_BRANCH << CMU_CLK_BRANCH_POS), /**< SYSTICK clock. */
  cmuClock_HCLK =
      (CMU_HCLK_BRANCH
       << CMU_CLK_BRANCH_POS), /**< Core and AHB bus interface clock. */
  cmuClock_EXPCLK =
      (CMU_EXPCLK_BRANCH << CMU_CLK_BRANCH_POS), /**< Export clock. */
  cmuClock_PCLK =
      (CMU_PCLK_BRANCH
  ...
  cmuClock_TRACECLK =
      (CMU_TRACECLK_BRANCH << CMU_CLK_BRANCH_POS), /**< Debug trace. */
  cmuClock_EM01GRPACLK =
      (CMU_EM01GRPACLK_BRANCH << CMU_CLK_BRANCH_POS), /**< EM01GRPA clock. */
#if defined(PDM_PRESENT)
  cmuClock_EM01GRPBCLK =
      (CMU_EM01GRPBCLK_BRANCH << CMU_CLK_BRANCH_POS), /**< EM01GRPB clock. */
#endif
#if defined(EUSART_PRESENT)
  cmuClock_EM01GRPCCLK =
      (CMU_EM01GRPCCLK_BRANCH << CMU_CLK_BRANCH_POS), /**< EM01GRPC clock. */
#endif
#if defined(EUART_PRESENT)
  cmuClock_EUART0CLK =
      (CMU_EUART0CLK_BRANCH << CMU_CLK_BRANCH_POS), /**< EUART0 clock. */
#elif defined(EUSART_PRESENT)
  cmuClock_EUSART0CLK =
      (CMU_EUART0CLK_BRANCH << CMU_CLK_BRANCH_POS), /**< EUSART0 clock. */
#endif
  cmuClock_IADCCLK =
      (CMU_IADCCLK_BRANCH << CMU_CLK_BRANCH_POS), /**< IADC clock. */
  cmuClock_EM23GRPACLK =
      (CMU_EM23GRPACLK_BRANCH << CMU_CLK_BRANCH_POS), /**< EM23GRPA clock. */
  cmuClock_WDOG0CLK =
      (CMU_WDOG0CLK_BRANCH << CMU_CLK_BRANCH_POS), /**< WDOG0 clock. */
#if WDOG_COUNT > 1
  cmuClock_WDOG1CLK =
      (CMU_WDOG1CLK_BRANCH << CMU_CLK_BRANCH_POS), /**< WDOG1 clock. */
#endif
#if defined(RTCC_PRESENT)
  cmuClock_RTCCCLK =
      (CMU_RTCCCLK_BRANCH << CMU_CLK_BRANCH_POS), /**< RTCC clock. */
#elif defined(SYSRTC_PRESENT)
  cmuClock_SYSRTCCLK =
      (CMU_SYSRTCCLK_BRANCH << CMU_CLK_BRANCH_POS), /**< SYSRTC clock. */
#endif
  cmuClock_EM4GRPACLK =
      (CMU_EM4GRPACLK_BRANCH << CMU_CLK_BRANCH_POS), /**< EM4GRPA clock. */
  cmuClock_DPLLREFCLK =
      (CMU_DPLLREFCLK_BRANCH << CMU_CLK_BRANCH_POS), /**< DPLLREF clock. */
...
#if defined(VDAC_PRESENT)
  cmuClock_VDAC0CLK =
      (CMU_VDAC0_BRANCH << CMU_CLK_BRANCH_POS), /**< VDAC0 clock. */
#if (VDAC_COUNT > 1)
  cmuClock_VDAC1CLK =
      (CMU_VDAC1_BRANCH << CMU_CLK_BRANCH_POS), /**< VDAC1 clock. */
#endif
#endif
#if defined(PCNT_PRESENT)
  cmuClock_PCNT0CLK =
      (CMU_PCNT_BRANCH << CMU_CLK_BRANCH_POS), /**< PCNT0 clock. */
#endif
#if defined(LESENSE_PRESENT)
  ...
  cmuClock_CORE =
      (CMU_CORE_BRANCH << CMU_CLK_BRANCH_POS), /**< Cortex-M33 core clock. */
#if defined(PDM_PRESENT)
  cmuClock_PDMREF =
      (CMU_PDMREF_BRANCH << CMU_CLK_BRANCH_POS), /**< PDMREF clock. */
#endif
  cmuClock_LDMA =
      (CMU_CLKEN0_EN_REG << CMU_EN_REG_POS)
  ...
  cmuClock_TIMER4 =
      (CMU_CLKEN1_EN_REG << CMU_EN_REG_POS)
