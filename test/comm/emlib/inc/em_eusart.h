...
typedef enum {
  ...
  eusartDataBits10 =
      EUSART_FRAMECFG_DATABITS_TEN, ///< 10 data bits, SPI mode only.
  eusartDataBits11 =
      EUSART_FRAMECFG_DATABITS_ELEVEN, ///< 11 data bits, SPI mode only.
  eusartDataBits12 =
      EUSART_FRAMECFG_DATABITS_TWELVE, ///< 12 data bits, SPI mode only.
  eusartDataBits13 =
      EUSART_FRAMECFG_DATABITS_THIRTEEN, ///< 13 data bits, SPI mode only.
  eusartDataBits14 =
      EUSART_FRAMECFG_DATABITS_FOURTEEN, ///< 14 data bits, SPI mode only.
  eusartDataBits15 =
      EUSART_FRAMECFG_DATABITS_FIFTEEN, ///< 15 data bits, SPI mode only.
  eusartDataBits16 =
      EUSART_FRAMECFG_DATABITS_SIXTEEN, ///< 16 data bits, SPI mode only.
#endif
...
typedef enum {
  eusartMajorityVoteEnable =
      EUSART_CFG0_MVDIS_DEFAULT, ///< Enable majority vote for 16x, 8x and 6x oversampling modes.
  eusartMajorityVoteDisable =
      EUSART_CFG0_MVDIS ///< Disable majority vote for 16x, 8x and 6x oversampling modes.
} EUSART_MajorityVote_TypeDef;

/// Block reception enable.
typedef enum {
  eusartBlockRxEnable =
      EUSART_CMD_RXBLOCKEN, ///< Block reception enable, resulting in all incoming frames being discarded.
  eusartBlockRxDisable =
      EUSART_CMD_RXBLOCKDIS ///< Block reception disable, resulting in all incoming frames being loaded into the RX FIFO.
} EUSART_BlockRx_TypeDef;

/// Tx output tristate enable.
typedef enum {
  eusartTristateTxEnable =
      EUSART_CMD_TXTRIEN, ///< Tristates the transmitter output.
  eusartTristateTxDisable =
      EUSART_CMD_TXTRIDIS ///< Disables tristating of the transmitter output.
} EUSART_TristateTx_TypeDef;

/// IrDA filter enable.
typedef enum {
  eusartIrDARxFilterEnable =
      EUSART_IRHFCFG_IRHFFILT_ENABLE, ///< Enable filter on demodulator.
  eusartIrDARxFilterDisable =
      EUSART_IRHFCFG_IRHFFILT_DISABLE ///< Disable filter on demodulator.
...
typedef enum {
  ...
  eusartInvertIODisable =
      (EUSART_CFG0_RXINV_DISABLE | EUSART_CFG0_TXINV_DISABLE),
...
typedef enum {
  ...
  eusartClockMode0 =
      EUSART_CFG2_CLKPOL_IDLELOW | EUSART_CFG2_CLKPHA_SAMPLELEADING,

  /// Clock idle low, sample on falling edge.
  eusartClockMode1 =
      EUSART_CFG2_CLKPOL_IDLELOW | EUSART_CFG2_CLKPHA_SAMPLETRAILING,

  /// Clock idle high, sample on falling edge.
  eusartClockMode2 =
      EUSART_CFG2_CLKPOL_IDLEHIGH | EUSART_CFG2_CLKPHA_SAMPLELEADING,

  /// Clock idle high, sample on rising edge.
  eusartClockMode3 =
      EUSART_CFG2_CLKPOL_IDLEHIGH | EUSART_CFG2_CLKPHA_SAMPLETRAILING
...
typedef enum {
  eusartDaliTxDataBits8 =
      EUSART_DALICFG_DALITXDATABITS_EIGHT, ///< Each frame contains 8  data bits.
  eusartDaliTxDataBits9 =
      EUSART_DALICFG_DALITXDATABITS_NINE, ///< Each frame contains 9  data bits.
  eusartDaliTxDataBits10 =
      EUSART_DALICFG_DALITXDATABITS_TEN, ///< Each frame contains 10 data bits.
  eusartDaliTxDataBits11 =
      EUSART_DALICFG_DALITXDATABITS_ELEVEN, ///< Each frame contains 11 data bits.
  eusartDaliTxDataBits12 =
      EUSART_DALICFG_DALITXDATABITS_TWELVE, ///< Each frame contains 12 data bits.
  eusartDaliTxDataBits13 =
      EUSART_DALICFG_DALITXDATABITS_THIRTEEN, ///< Each frame contains 13 data bits.
  eusartDaliTxDataBits14 =
      EUSART_DALICFG_DALITXDATABITS_FOURTEEN, ///< Each frame contains 14 data bits.
  eusartDaliTxDataBits15 =
      EUSART_DALICFG_DALITXDATABITS_FIFTEEN, ///< Each frame contains 15 data bits.
  eusartDaliTxDataBits16 =
      EUSART_DALICFG_DALITXDATABITS_SIXTEEN, ///< Each frame contains 16 data bits.
  eusartDaliTxDataBits17 =
      EUSART_DALICFG_DALITXDATABITS_SEVENTEEN, ///< Each frame contains 17 data bits.
  eusartDaliTxDataBits18 =
      EUSART_DALICFG_DALITXDATABITS_EIGHTEEN, ///< Each frame contains 18 data bits.
  eusartDaliTxDataBits19 =
      EUSART_DALICFG_DALITXDATABITS_NINETEEN, ///< Each frame contains 19 data bits.
  eusartDaliTxDataBits20 =
      EUSART_DALICFG_DALITXDATABITS_TWENTY, ///< Each frame contains 20 data bits.
  eusartDaliTxDataBits21 =
      EUSART_DALICFG_DALITXDATABITS_TWENTYONE, ///< Each frame contains 21 data bits.
  eusartDaliTxDataBits22 =
      EUSART_DALICFG_DALITXDATABITS_TWENTYTWO, ///< Each frame contains 22 data bits.
  eusartDaliTxDataBits23 =
      EUSART_DALICFG_DALITXDATABITS_TWENTYEIGHT, ///< Each frame contains 23 data bits.
  eusartDaliTxDataBits24 =
      EUSART_DALICFG_DALITXDATABITS_TWENTYFOUR, ///< Each frame contains 24 data bits.
  eusartDaliTxDataBits25 =
      EUSART_DALICFG_DALITXDATABITS_TWENTYFIVE, ///< Each frame contains 25 data bits.
  eusartDaliTxDataBits26 =
      EUSART_DALICFG_DALITXDATABITS_TWENTYSIX, ///< Each frame contains 26 data bits.
  eusartDaliTxDataBits27 =
      EUSART_DALICFG_DALITXDATABITS_TWENTYSEVEN, ///< Each frame contains 27 data bits.
  eusartDaliTxDataBits28 =
      EUSART_DALICFG_DALITXDATABITS_TWENTYEIGHT, ///< Each frame contains 28 data bits.
  eusartDaliTxDataBits29 =
      EUSART_DALICFG_DALITXDATABITS_TWENTYNINE, ///< Each frame contains 29 data bits.
  eusartDaliTxDataBits30 =
      EUSART_DALICFG_DALITXDATABITS_THIRTY, ///< Each frame contains 30 data bits.
  eusartDaliTxDataBits31 =
      EUSART_DALICFG_DALITXDATABITS_THIRTYONE, ///< Each frame contains 31 data bits.
  eusartDaliTxDataBits32 =
      EUSART_DALICFG_DALITXDATABITS_THIRTYTWO, ///< Each frame contains 32 data bits.
} EUSART_DaliTxDatabits_TypeDef;

/// DALI RX databits (8-32).
typedef enum {
  eusartDaliRxDataBits8 =
      EUSART_DALICFG_DALIRXDATABITS_EIGHT, ///< Each frame contains 8  data bits.
  eusartDaliRxDataBits9 =
      EUSART_DALICFG_DALIRXDATABITS_NINE, ///< Each frame contains 9  data bits.
  eusartDaliRxDataBits10 =
      EUSART_DALICFG_DALIRXDATABITS_TEN, ///< Each frame contains 10 data bits.
  eusartDaliRxDataBits11 =
      EUSART_DALICFG_DALIRXDATABITS_ELEVEN, ///< Each frame contains 11 data bits.
  eusartDaliRxDataBits12 =
      EUSART_DALICFG_DALIRXDATABITS_TWELVE, ///< Each frame contains 12 data bits.
  eusartDaliRxDataBits13 =
      EUSART_DALICFG_DALIRXDATABITS_THIRTEEN, ///< Each frame contains 13 data bits.
  eusartDaliRxDataBits14 =
      EUSART_DALICFG_DALIRXDATABITS_FOURTEEN, ///< Each frame contains 14 data bits.
  eusartDaliRxDataBits15 =
      EUSART_DALICFG_DALIRXDATABITS_FIFTEEN, ///< Each frame contains 15 data bits.
  eusartDaliRxDataBits16 =
      EUSART_DALICFG_DALIRXDATABITS_SIXTEEN, ///< Each frame contains 16 data bits.
  eusartDaliRxDataBits17 =
      EUSART_DALICFG_DALIRXDATABITS_SEVENTEEN, ///< Each frame contains 17 data bits.
  eusartDaliRxDataBits18 =
      EUSART_DALICFG_DALIRXDATABITS_EIGHTEEN, ///< Each frame contains 18 data bits.
  eusartDaliRxDataBits19 =
      EUSART_DALICFG_DALIRXDATABITS_NINETEEN, ///< Each frame contains 19 data bits.
  eusartDaliRxDataBits20 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTY, ///< Each frame contains 20 data bits.
  eusartDaliRxDataBits21 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTYONE, ///< Each frame contains 21 data bits.
  eusartDaliRxDataBits22 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTYTWO, ///< Each frame contains 22 data bits.
  eusartDaliRxDataBits23 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTYEIGHT, ///< Each frame contains 23 data bits.
  eusartDaliRxDataBits24 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTYFOUR, ///< Each frame contains 24 data bits.
  eusartDaliRxDataBits25 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTYFIVE, ///< Each frame contains 25 data bits.
  eusartDaliRxDataBits26 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTYSIX, ///< Each frame contains 26 data bits.
  eusartDaliRxDataBits27 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTYSEVEN, ///< Each frame contains 27 data bits.
  eusartDaliRxDataBits28 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTYEIGHT, ///< Each frame contains 28 data bits.
  eusartDaliRxDataBits29 =
      EUSART_DALICFG_DALIRXDATABITS_TWENTYNINE, ///< Each frame contains 29 data bits.
  eusartDaliRxDataBits30 =
      EUSART_DALICFG_DALIRXDATABITS_THIRTY, ///< Each frame contains 30 data bits.
  eusartDaliRxDataBits31 =
      EUSART_DALICFG_DALIRXDATABITS_THIRTYONE, ///< Each frame contains 31 data bits.
  eusartDaliRxDataBits32 =
      EUSART_DALICFG_DALIRXDATABITS_THIRTYTWO, ///< Each frame contains 32 data bits.
