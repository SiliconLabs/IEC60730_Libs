...
typedef enum {
  ...
  prsLogic_NOT_A_AND_B =
      _PRS_ASYNC_CH_CTRL_FNSEL_NOT_A_AND_B,        /**< (!A) NOR B. */
  prsLogic_NOT_A = _PRS_ASYNC_CH_CTRL_FNSEL_NOT_A, /**< !A. */
  prsLogic_A_AND_NOT_B =
      _PRS_ASYNC_CH_CTRL_FNSEL_A_AND_NOT_B,                  /**< A AND (!B). */
...
typedef enum {
  ...
  prsSignalSW =
      PRS_SYNC_CH_CTRL_SOURCESEL_DEFAULT
      | (0x1
         << _PRS_SYNC_CH_CTRL_SIGSEL_SHIFT), /**< Software-reserved Signal. */
#else
  prsSignalNone = PRS_CH_CTRL_SOURCESEL_NONE
                  | (0x0 << _PRS_CH_CTRL_SIGSEL_SHIFT), /**< No Signal. */
  prsSignalSW =
      PRS_CH_CTRL_SOURCESEL_NONE
      | (0x1 << _PRS_CH_CTRL_SIGSEL_SHIFT), /**< Software-reserved Signal. */
#endif
  ...
  prsSignalTIMER0_CC0 =
      PRS_TIMER0_CC0, /**< TIMER0 capture/compare channel 0 Signal. */
  prsSignalTIMER0_CC1 =
      PRS_TIMER0_CC1, /**< TIMER0 capture/compare channel 1 Signal. */
  prsSignalTIMER0_CC2 =
      PRS_TIMER0_CC2, /**< TIMER0 capture/compare channel 2 Signal. */
#endif
#if defined(TIMER1)
  prsSignalTIMER1_UF = PRS_TIMER1_UF, /**< TIMER1 underflow Signal. */
  prsSignalTIMER1_OF = PRS_TIMER1_OF, /**< TIMER1 overflow Signal. */
  prsSignalTIMER1_CC0 =
      PRS_TIMER1_CC0, /**< TIMER1 capture/compare channel 0 Signal. */
  prsSignalTIMER1_CC1 =
      PRS_TIMER1_CC1, /**< TIMER1 capture/compare channel 1 Signal. */
  prsSignalTIMER1_CC2 =
      PRS_TIMER1_CC2, /**< TIMER1 capture/compare channel 2 Signal. */
#endif
#if defined(TIMER2)
  prsSignalTIMER2_UF = PRS_TIMER2_UF, /**< TIMER2 underflow Signal. */
  prsSignalTIMER2_OF = PRS_TIMER2_OF, /**< TIMER2 overflow Signal. */
  prsSignalTIMER2_CC0 =
      PRS_TIMER2_CC0, /**< TIMER2 capture/compare channel 0 Signal. */
  prsSignalTIMER2_CC1 =
      PRS_TIMER2_CC1, /**< TIMER2 capture/compare channel 1 Signal. */
  prsSignalTIMER2_CC2 =
      PRS_TIMER2_CC2, /**< TIMER2 capture/compare channel 2 Signal. */
#endif
#if defined(TIMER3)
  prsSignalTIMER3_UF = PRS_TIMER3_UF, /**< TIMER3 underflow Signal. */
  prsSignalTIMER3_OF = PRS_TIMER3_OF, /**< TIMER3 overflow Signal. */
  prsSignalTIMER3_CC0 =
      PRS_TIMER3_CC0, /**< TIMER3 capture/compare channel 0 Signal. */
  prsSignalTIMER3_CC1 =
      PRS_TIMER3_CC1, /**< TIMER3 capture/compare channel 1 Signal. */
  prsSignalTIMER3_CC2 =
      PRS_TIMER3_CC2, /**< TIMER3 capture/compare channel 2 Signal. */
#if defined(PRS_TIMER1_CC3)
  prsSignalTIMER1_CC3 =
      PRS_TIMER1_CC3, /**< TIMER3 capture/compare channel 3 Signal. */
#endif
#endif
#if defined(TIMER4)
  ...
  prsSignalTIMER4_CC0 =
      PRS_TIMER4_CC0, /**< TIMER4 capture/compare channel 0 Signal. */
  prsSignalTIMER4_CC1 =
      PRS_TIMER4_CC1, /**< TIMER4 capture/compare channel 1 Signal. */
  prsSignalTIMER4_CC2 =
      PRS_TIMER4_CC2, /**< TIMER4 capture/compare channel 2 Signal. */
#endif
#if defined(TIMER5)
  prsSignalTIMER5_UF = PRS_TIMER5_UF, /**< TIMER5 underflow Signal. */
  prsSignalTIMER5_OF = PRS_TIMER5_OF, /**< TIMER5 overflow Signal. */
  prsSignalTIMER5_CC0 =
      PRS_TIMER5_CC0, /**< TIMER5 capture/compare channel 0 Signal. */
  prsSignalTIMER5_CC1 =
      PRS_TIMER5_CC1, /**< TIMER5 capture/compare channel 1 Signal. */
  prsSignalTIMER5_CC2 =
      PRS_TIMER5_CC2, /**< TIMER5 capture/compare channel 2 Signal. */
#endif
#if defined(TIMER6)
  prsSignalTIMER6_UF = PRS_TIMER6_UF, /**< TIMER6 underflow Signal. */
  prsSignalTIMER6_OF = PRS_TIMER6_OF, /**< TIMER6 overflow Signal. */
  prsSignalTIMER6_CC0 =
      PRS_TIMER6_CC0, /**< TIMER6 capture/compare channel 0 Signal. */
  prsSignalTIMER6_CC1 =
      PRS_TIMER6_CC1, /**< TIMER6 capture/compare channel 1 Signal. */
  prsSignalTIMER6_CC2 =
      PRS_TIMER6_CC2, /**< TIMER6 capture/compare channel 2 Signal. */
#endif
  ...
  prsSignalCRYOTIMER_PERIOD =
      PRS_CRYOTIMER_PERIOD, /**< CRYOTIMER_PERIOD Signal. */
#endif
...
#if defined(RTCC)
  prsSignalRTCC_CCV0 =
      PRS_RTCC_CCV0, /**< RTCC capture/compare channel 0 Signal. */
  prsSignalRTCC_CCV1 =
      PRS_RTCC_CCV1, /**< RTCC capture/compare channel 1 Signal. */
  prsSignalRTCC_CCV2 =
      PRS_RTCC_CCV2, /**< RTCC capture/compare channel 2 Signal. */
#endif
#if defined(BURTC)
  ...
  prsSignalSYSRTC0_GRP0OUT0 =
      PRS_SYSRTC0_GRP0OUT0, /**< SYSRTC GRP0OUT0 Signal. */
  prsSignalSYSRTC0_GRP0OUT1 =
      PRS_SYSRTC0_GRP0OUT1, /**< SYSRTC GRP0OUT1 Signal. */
  prsSignalSYSRTC0_GRP1OUT0 =
      PRS_SYSRTC0_GRP1OUT0, /**< SYSRTC GRP1OUT0 Signal. */
  prsSignalSYSRTC0_GRP1OUT1 =
      PRS_SYSRTC0_GRP1OUT1, /**< SYSRTC GRP1OUT1 Signal. */
#endif
  ...
  prsSignalHFRCOEM23_COREEN =
      PRS_HFRCOEM23_COREEN, /**< HFRCOEM23_COREEN  Signal. */
  prsSignalHFRCOEM23_STATE0 =
      PRS_HFRCOEM23_STATE0, /**< HFRCOEM23_STATE0  Signal. */
  prsSignalHFRCOEM23_STATE1 =
      PRS_HFRCOEM23_STATE1, /**< HFRCOEM23_STATE1  Signal. */
  prsSignalHFRCOEM23_STATE2 =
      PRS_HFRCOEM23_STATE2, /**< HFRCOEM23_STATE2  Signal. */
#endif
  ...
  prsSignalVDAC0_CH0WARM =
      PRS_VDAC0L_CH0WARM, /**< VDAC0 channel 0 warmed Signal. */
  prsSignalVDAC0_CH1WARM =
      PRS_VDAC0L_CH1WARM, /**< VDAC0 channel 1 warmed Signal. */
  prsSignalVDAC0_CH0DONE =
      PRS_VDAC0L_CH0DONEASYNC, /**< VDAC0 channel 0 conversion done Signal. */
  prsSignalVDAC0_CH1DONE =
      PRS_VDAC0L_CH1DONEASYNC, /**< VDAC0 channel 1 conversion done Signal. */
  prsSignalVDAC0_INTERNALTIMEROF =
      PRS_VDAC0L_INTERNALTIMEROF, /**< VDAC0 internal timer overflow Signal. */
  prsSignalVDAC0_REFRESHTIMEROF =
      PRS_VDAC0L_REFRESHTIMEROF, /**< VDAC0 internal timer overflow Signal. */
#endif
  ...
  prsSignalVDAC1_CH0WARM =
      PRS_VDAC1L_CH0WARM, /**< VDAC1 channel 0 warmed Signal. */
  prsSignalVDAC1_CH1WARM =
      PRS_VDAC1L_CH1WARM, /**< VDAC1 channel 1 warmed Signal. */
  prsSignalVDAC1_CH0DONE =
      PRS_VDAC1L_CH0DONEASYNC, /**< VDAC1 channel 0 conversion done Signal. */
  prsSignalVDAC1_CH1DONE =
      PRS_VDAC1L_CH1DONEASYNC, /**< VDAC1 channel 1 conversion done Signal. */
  prsSignalVDAC1_INTERNALTIMEROF =
      PRS_VDAC1L_INTERNALTIMEROF, /**< VDAC1 internal timer overflow Signal. */
  prsSignalVDAC1_REFRESHTIMEROF =
      PRS_VDAC1L_REFRESHTIMEROF, /**< VDAC1 internal timer overflow Signal. */
#endif

#if defined(PRS_LESENSE_SCANRES15)
  prsSignalLESENSE_SCANRES0 =
      PRS_LESENSE_SCANRES0, /**< LESENSE_SCANRES0  Signal. */
  prsSignalLESENSE_SCANRES1 =
      PRS_LESENSE_SCANRES1, /**< LESENSE_SCANRES1  Signal. */
  prsSignalLESENSE_SCANRES2 =
      PRS_LESENSE_SCANRES2, /**< LESENSE_SCANRES2  Signal. */
  prsSignalLESENSE_SCANRES3 =
      PRS_LESENSE_SCANRES3, /**< LESENSE_SCANRES3  Signal. */
  prsSignalLESENSE_SCANRES4 =
      PRS_LESENSE_SCANRES4, /**< LESENSE_SCANRES4  Signal. */
  prsSignalLESENSE_SCANRES5 =
      PRS_LESENSE_SCANRES5, /**< LESENSE_SCANRES5  Signal. */
  prsSignalLESENSE_SCANRES6 =
      PRS_LESENSE_SCANRES6, /**< LESENSE_SCANRES6  Signal. */
  prsSignalLESENSE_SCANRES7 =
      PRS_LESENSE_SCANRES7, /**< LESENSE_SCANRES7  Signal. */
  prsSignalLESENSE_SCANRES8 =
      PRS_LESENSE_SCANRES8, /**< LESENSE_SCANRES8  Signal. */
  prsSignalLESENSE_SCANRES9 =
      PRS_LESENSE_SCANRES9, /**< LESENSE_SCANRES9  Signal. */
  prsSignalLESENSE_SCANRES10 =
      PRS_LESENSE_SCANRES10, /**< LESENSE_SCANRES10 Signal. */
  prsSignalLESENSE_SCANRES11 =
      PRS_LESENSE_SCANRES11, /**< LESENSE_SCANRES11 Signal. */
  prsSignalLESENSE_SCANRES12 =
      PRS_LESENSE_SCANRES12, /**< LESENSE_SCANRES12 Signal. */
  prsSignalLESENSE_SCANRES13 =
      PRS_LESENSE_SCANRES13, /**< LESENSE_SCANRES13 Signal. */
  prsSignalLESENSE_SCANRES14 =
      PRS_LESENSE_SCANRES14, /**< LESENSE_SCANRES14 Signal. */
  prsSignalLESENSE_SCANRES15 =
      PRS_LESENSE_SCANRES15, /**< LESENSE_SCANRES15 Signal. */
#endif
  ...
  prsSignalLESENSE_DECOUT0 =
      PRS_LESENSE_DECOUT0, /**< LESENSE_DECOUT0    Signal. */
  prsSignalLESENSE_DECOUT1 =
      PRS_LESENSE_DECOUT1, /**< LESENSE_DECOUT1    Signal. */
  prsSignalLESENSE_DECOUT2 =
      PRS_LESENSE_DECOUT2, /**< LESENSE_DECOUT2    Signal. */
#endif
  ...
  prsSignalLESENSE_MEASACT =
      PRS_LESENSE_MEASACT, /**< LESENSE_MEASACT Signal. */
#endif
  ...
  prsSignalUSART0_RXDATA =
      PRS_USART0_RXDATA, /**< USART0 rx data available Signal. */
#endif
#if defined(PRS_USART0_RXDATAV)
  prsSignalUSART0_RXDATAV =
      PRS_USART0_RXDATAV, /**< USART0 rx data available Signal. */
#endif
  ...
  prsSignalUSART1_RXDATA =
      PRS_USART1_RXDATA, /**< USART1 rx data available Signal. */
#endif
#if defined(PRS_USART1_RXDATAV)
  prsSignalUSART1_RXDATAV =
      PRS_USART1_RXDATAV, /**< USART1 rx data available Signal. */
#endif
  ...
  prsSignalUSART2_RXDATA =
      PRS_USART2_RXDATA, /**< USART2 rx data available Signal. */
#endif
#if defined(PRS_USART2_RXDATAV)
  prsSignalUSART2_RXDATAV =
      PRS_USART2_RXDATAV, /**< USART2 rx data available Signal. */
#endif
  ...
  prsSignalUSART3_RXDATAV =
      PRS_USART3_RXDATAV,               /**< USART3 rx data available Signal. */
  ...
  prsSignalUSART4_RXDATAV =
      PRS_USART4_RXDATAV,               /**< USART4 rx data available Signal. */
  ...
  prsSignalUSART5_RXDATAV =
      PRS_USART5_RXDATAV,               /**< USART5 rx data available Signal. */
  ...
  prsSignalUART0_RXDATAV =
      PRS_UART0_RXDATAV, /**< UART0 rx data available Signal. */
  ...
  prsSignalUART1_RXDATAV =
      PRS_UART1_RXDATAV, /**< UART1 rx data available Signal. */
#if defined(PRS_UART1_IRTX)
  ...
  prsSignalCM4_ICACHEPCHITSOF =
      PRS_CM4_ICACHEPCHITSOF, /**< ICACHEPCHITSOF   Signal. */
  prsSignalCM4_ICACHEPCMISSESOF =
      PRS_CM4_ICACHEPCMISSESOF, /**< ICACHEPCMISSESOF Signal. */
#endif
...
/* EUSART Signals */
  ...
  prsSignalEUSART0_RXDATA =
      PRS_EUSART0L_RXDATAV, /**< EUSART0 rx data available Signal. */
  ...
  prsSignalEUSART1_RXDATA =
      PRS_EUSART1L_RXDATAV, /**< EUSART1 rx data available Signal. */
  ...
  prsSignalEUSART2_RXDATA =
      PRS_EUSART2L_RXDATAV, /**< EUSART2 rx data available Signal. */
...
/* ADC Signals */
  ...
  prsSignalIADC0_SCANENTRY =
      PRS_IADC0_SCANENTRYDONE, /**< IADC0 scan entry Signal. */
  prsSignalIADC0_SCANTABLE =
      PRS_IADC0_SCANTABLEDONE,                  /**< IADC0 scan table Signal. */
  ...
  prsSignalAGCL_GAINADJUST =
      PRS_AGCL_GAINADJUST,                /**< AGCL_GAINADJUST Signal. */
  prsSignalAGCL_GAINOK = PRS_AGCL_GAINOK, /**< AGCL_GAINOK Signal. */
  prsSignalAGCL_GAINREDUCED =
      PRS_AGCL_GAINREDUCED,                 /**< AGCL_GAINREDUCED Signal. */
  ...
  prsSignalMODEML_COHDSADET =
      PRS_MODEML_COHDSADET, /**< MODEML_COHDSADET Signal. */
  prsSignalMODEML_COHDSALIVE =
      PRS_MODEML_COHDSALIVE,              /**< MODEML_COHDSALIVE Signal. */
  ...
  prsSignalMODEML_FRAMEDET =
      PRS_MODEML_FRAMEDET, /**< MODEML_FRAMEDET Signal. */
#endif
  ...
  prsSignalMODEM_FRAMESENT =
      PRS_MODEM_FRAMESENT, /**< MODEM_FRAMESENT Signal. */
#endif
  ...
  prsSignalMODEMH_RSSIJUMP =
      PRS_MODEMH_RSSIJUMP, /**< MODEMH_RSSIJUMP Signal. */
  prsSignalMODEMH_SYNCSENT =
      PRS_MODEMH_SYNCSENT,                    /**< MODEMH_SYNCSENT Signal. */
  ...
  prsSignalPROTIMER_T0MATCH =
      PRS_PROTIMER_T0MATCH,                   /**< PROTIMER_T0MATCH Signal. */
  prsSignalPROTIMER_T0UF = PRS_PROTIMER_T0UF, /**< PROTIMER_T0UF Signal. */
  prsSignalPROTIMER_T1MATCH =
      PRS_PROTIMER_T1MATCH,                   /**< PROTIMER_T1MATCH Signal. */
  ...
  prsSignalRAC_AUXADCDATAVALID =
      PRS_RAC_AUXADCDATAVALID, /**< RAC_AUXADCDATAVALID Signal. */
#endif
  ...
  prsSignalLVGD_LVGDFALLDETECTED =
      PRS_LVGD_LVGDFALLDETECTED, /**< LVGD_LVGDFALLDETECTED Signal. */
  prsSignalLVGD_LVGDFALLDETECTEDRAW =
      PRS_LVGD_LVGDFALLDETECTEDRAW, /**< LVGD_LVGDFALLDETECTEDRAW Signal. */
  prsSignalLVGD_LVGDRISEDETECTED =
      PRS_LVGD_LVGDRISEDETECTED, /**< LVGD_LVGDRISEDETECTED Signal. */
  prsSignalLVGD_LVGDRISEDETECTEDRAW =
      PRS_LVGD_LVGDRISEDETECTEDRAW, /**< LVGD_LVGDRISEDETECTEDRAW Signal. */
#endif
  ...
  prsSignalSEATAMPDET_SEATAMPDETSUPTPDELAY =
      PRS_SEATAMPDET_SEATAMPDETSUPTPDELAY, /**< SEATAMPDET_SEATAMPDETSUPTPDELAY Signal. */
#endif
} PRS_Signal_t;
...
typedef enum {
  ...
  prsConsumerCMU_CALDN =
      offsetof(PRS_TypeDef,
               CONSUMER_CMU_CALDN), /**< CMU calibration down consumer. */
  prsConsumerCMU_CALUP =
      offsetof(PRS_TypeDef,
               CONSUMER_CMU_CALUP), /**< CMU calibration up consumer. */
  prsConsumerIADC0_SCANTRIGGER =
      offsetof(PRS_TypeDef,
               CONSUMER_IADC0_SCANTRIGGER), /**< IADC0 scan trigger consumer. */
  prsConsumerIADC0_SINGLETRIGGER = offsetof(
      PRS_TypeDef,
      CONSUMER_IADC0_SINGLETRIGGER), /**< IADC0 single trigger consumer. */
  prsConsumerLDMA_REQUEST0 =
      offsetof(PRS_TypeDef,
               CONSUMER_LDMAXBAR_DMAREQ0), /**< LDMA Request 0 consumer. */
  prsConsumerLDMA_REQUEST1 =
      offsetof(PRS_TypeDef,
               CONSUMER_LDMAXBAR_DMAREQ1), /**< LDMA Request 1 consumer. */
#if defined(LETIMER0)
  prsConsumerLETIMER0_CLEAR =
      offsetof(PRS_TypeDef,
               CONSUMER_LETIMER0_CLEAR), /**< LETIMER0 clear consumer. */
  prsConsumerLETIMER0_START =
      offsetof(PRS_TypeDef,
               CONSUMER_LETIMER0_START), /**< LETIMER0 start consumer. */
  prsConsumerLETIMER0_STOP =
      offsetof(PRS_TypeDef,
               CONSUMER_LETIMER0_STOP), /**< LETIMER0 stop consumer. */
#endif
  prsConsumerTIMER0_CC0 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER0_CC0), /**< TIMER0 capture/compare channel 0 consumer. */
  prsConsumerTIMER0_CC1 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER0_CC1), /**< TIMER0 capture/compare channel 1 consumer. */
  prsConsumerTIMER0_CC2 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER0_CC2), /**< TIMER0 capture/compare channel 2 consumer. */
  prsConsumerTIMER1_CC0 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER1_CC0), /**< TIMER1 capture/compare channel 0 consumer. */
  prsConsumerTIMER1_CC1 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER1_CC1), /**< TIMER1 capture/compare channel 1 consumer. */
  prsConsumerTIMER1_CC2 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER1_CC2), /**< TIMER1 capture/compare channel 2 consumer. */
  prsConsumerTIMER2_CC0 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER2_CC0), /**< TIMER2 capture/compare channel 0 consumer. */
  prsConsumerTIMER2_CC1 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER2_CC1), /**< TIMER2 capture/compare channel 1 consumer. */
  prsConsumerTIMER2_CC2 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER2_CC2), /**< TIMER2 capture/compare channel 2 consumer. */
  prsConsumerTIMER3_CC0 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER3_CC0), /**< TIMER3 capture/compare channel 0 consumer. */
  prsConsumerTIMER3_CC1 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER3_CC1), /**< TIMER3 capture/compare channel 1 consumer. */
  prsConsumerTIMER3_CC2 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER3_CC2), /**< TIMER3 capture/compare channel 2 consumer. */
#if defined(TIMER4)
  prsConsumerTIMER4_CC0 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER4_CC0), /**< TIMER4 capture/compare channel 0 consumer. */
  prsConsumerTIMER4_CC1 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER4_CC1), /**< TIMER4 capture/compare channel 1 consumer. */
  prsConsumerTIMER4_CC2 = offsetof(
      PRS_TypeDef,
      CONSUMER_TIMER4_CC2), /**< TIMER4 capture/compare channel 2 consumer. */
#endif
#if defined(USART0)
  prsConsumerUSART0_CLK =
      offsetof(PRS_TypeDef, CONSUMER_USART0_CLK), /**< USART0 clock consumer. */
  prsConsumerUSART0_IR =
      offsetof(PRS_TypeDef, CONSUMER_USART0_IR), /**< USART0 IR consumer. */
  prsConsumerUSART0_RX =
      offsetof(PRS_TypeDef, CONSUMER_USART0_RX), /**< USART0 rx consumer. */
  prsConsumerUSART0_TRIGGER =
      offsetof(PRS_TypeDef,
               CONSUMER_USART0_TRIGGER), /**< USART0 trigger consumer. */
#endif
#if defined(USART1)
  prsConsumerUSART1_CLK =
      offsetof(PRS_TypeDef, CONSUMER_USART1_CLK), /**< USART1 clock consumer. */
  prsConsumerUSART1_IR =
      offsetof(PRS_TypeDef, CONSUMER_USART1_IR), /**< USART1 IR consumer. */
  prsConsumerUSART1_RX =
      offsetof(PRS_TypeDef, CONSUMER_USART1_RX), /**< USART1 rx consumer. */
  prsConsumerUSART1_TRIGGER =
      offsetof(PRS_TypeDef,
               CONSUMER_USART1_TRIGGER), /**< USART1 trigger consumer. */
#endif
#if defined(USART2)
  prsConsumerUSART2_CLK =
      offsetof(PRS_TypeDef, CONSUMER_USART2_CLK), /**< USART2 clock consumer. */
  prsConsumerUSART2_IR =
      offsetof(PRS_TypeDef, CONSUMER_USART2_IR), /**< USART2 IR consumer. */
  prsConsumerUSART2_RX =
      offsetof(PRS_TypeDef, CONSUMER_USART2_RX), /**< USART2 rx consumer. */
  prsConsumerUSART2_TRIGGER =
      offsetof(PRS_TypeDef,
               CONSUMER_USART2_TRIGGER), /**< USART2 trigger consumer. */
#endif
#if defined(EUSART0)
  prsConsumerEUSART0_CLK =
      offsetof(PRS_TypeDef, CONSUMER_EUSART0_CLK), /**< EUSART0 clk consumer. */
  prsConsumerEUSART0_RX =
      offsetof(PRS_TypeDef, CONSUMER_EUSART0_RX), /**< EUSART0 rx consumer. */
  ...
  prsConsumerEUSART1_CLK =
      offsetof(PRS_TypeDef, CONSUMER_EUSART1_CLK), /**< EUSART1 clk consumer. */
  prsConsumerEUSART1_RX =
      offsetof(PRS_TypeDef, CONSUMER_EUSART1_RX), /**< EUSART1 rx consumer. */
  ...
  prsConsumerEUSART2_CLK =
      offsetof(PRS_TypeDef, CONSUMER_EUSART2_CLK), /**< EUSART1 clk consumer. */
  prsConsumerEUSART2_RX =
      offsetof(PRS_TypeDef, CONSUMER_EUSART2_RX), /**< EUSART2 rx consumer. */
  prsConsumerEUSART2_TRIGGER =
      offsetof(PRS_TypeDef,
               CONSUMER_EUSART2_TRIGGER), /**< EUSART2 trigger consumer. */
#endif

#if defined(EUART0)
  prsConsumerEUART0_RX =
      offsetof(PRS_TypeDef, CONSUMER_EUART0_RX), /**< EUART0 RX consumer. */
  prsConsumerEUART0_TRIGGER =
      offsetof(PRS_TypeDef,
               CONSUMER_EUART0_TRIGGER), /**< EUART0 TRIGGER Consumer. */
#endif
  prsConsumerWDOG0_SRC0 =
      offsetof(PRS_TypeDef,
               CONSUMER_WDOG0_SRC0), /**< WDOG0 source 0 consumer. */
  prsConsumerWDOG0_SRC1 =
      offsetof(PRS_TypeDef,
               CONSUMER_WDOG0_SRC1), /**< WDOG0 source 1 consumer. */
#if defined(WDOG1)
  prsConsumerWDOG1_SRC0 =
      offsetof(PRS_TypeDef,
               CONSUMER_WDOG1_SRC0), /**< WDOG1 source 0 consumer. */
  prsConsumerWDOG1_SRC1 =
      offsetof(PRS_TypeDef,
               CONSUMER_WDOG1_SRC1), /**< WDOG1 source 1 consumer. */
#endif
#if defined(PCNT0)
  prsConsumerPCNT0_IN0 =
      offsetof(PRS_TypeDef,
               CONSUMER_PCNT0_S0IN), /**< PCNT0 input 0 consumer. */
  prsConsumerPCNT0_IN1 =
      offsetof(PRS_TypeDef,
               CONSUMER_PCNT0_S1IN), /**< PCNT0 input 1 consumer. */
#endif
#if defined(_PRS_CONSUMER_RTCC_CC2_MASK)
  prsConsumerRTCC_CC0 = offsetof(
      PRS_TypeDef,
      CONSUMER_RTCC_CC0), /**< RTCC capture/compare channel 0 consumer. */
  prsConsumerRTCC_CC1 = offsetof(
      PRS_TypeDef,
      CONSUMER_RTCC_CC1), /**< RTCC capture/compare channel 1 consumer. */
  prsConsumerRTCC_CC2 = offsetof(
      PRS_TypeDef,
      CONSUMER_RTCC_CC2), /**< RTCC capture/compare channel 2 consumer. */
#endif
#if defined(SYSRTC0)
  prsConsumerSYSRTC0_SRC0 =
      offsetof(PRS_TypeDef,
               CONSUMER_SYSRTC0_IN0), /**< SYSRTC0 input 0 consumer. */
  prsConsumerSYSRTC0_SRC1 =
      offsetof(PRS_TypeDef,
               CONSUMER_SYSRTC0_IN1), /**< SYSRTC0 input 1 consumer. */
#endif
#if defined(_PRS_CONSUMER_HFXO0_OSCREQ_MASK)
  prsConsumerHFXO0_OSCREQ =
      offsetof(PRS_TypeDef, CONSUMER_HFXO0_OSCREQ), /**< OSCREQ consumer. */
  prsConsumerHFXO0_TIMEOUT =
      offsetof(PRS_TypeDef,
               CONSUMER_HFXO0_TIMEOUT), /**< HFXO0_TIMEOUT consumer. */
#endif
#if defined(LESENSE)
  prsConsumerLESENSE_START =
      offsetof(PRS_TypeDef,
               CONSUMER_LESENSE_START), /**< LESENSE_START consumer. */
#endif
#if defined(VDAC0)
  prsConsumerVDAC0_ASYNCTRIGCH0 =
      offsetof(PRS_TypeDef, CONSUMER_VDAC0_ASYNCTRIGCH0),
  prsConsumerVDAC0_ASYNCTRIGCH1 =
      offsetof(PRS_TypeDef, CONSUMER_VDAC0_ASYNCTRIGCH1),
  prsConsumerVDAC0_SYNCTRIGCH0 =
      offsetof(PRS_TypeDef, CONSUMER_VDAC0_SYNCTRIGCH0),
  prsConsumerVDAC0_SYNCTRIGCH1 =
      offsetof(PRS_TypeDef, CONSUMER_VDAC0_SYNCTRIGCH1),
#endif
#if defined(VDAC1)
  prsConsumerVDAC1_ASYNCTRIGCH0 =
      offsetof(PRS_TypeDef, CONSUMER_VDAC1_ASYNCTRIGCH0),
  prsConsumerVDAC1_ASYNCTRIGCH1 =
      offsetof(PRS_TypeDef, CONSUMER_VDAC1_ASYNCTRIGCH1),
  prsConsumerVDAC1_SYNCTRIGCH0 =
      offsetof(PRS_TypeDef, CONSUMER_VDAC1_SYNCTRIGCH0),
  prsConsumerVDAC1_SYNCTRIGCH1 =
      offsetof(PRS_TypeDef, CONSUMER_VDAC1_SYNCTRIGCH1),
#endif
} PRS_Consumer_t;
#endif
