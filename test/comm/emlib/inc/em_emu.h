...
typedef enum {
  emuDcdcDriveSpeed_BestEmi =
      _DCDC_EM01CTRL0_DRVSPEED_BEST_EMI, /**< Lowest efficiency, lowest EMI. */
  emuDcdcDriveSpeed_Default =
      _DCDC_EM01CTRL0_DRVSPEED_DEFAULT_SETTING, /**< Default efficiency, acceptable EMI level. */
  emuDcdcDriveSpeed_Intermediate =
      _DCDC_EM01CTRL0_DRVSPEED_INTERMEDIATE, /**< Small increase in efficiency from the default setting. */
  emuDcdcDriveSpeed_BestEfficiency =
      _DCDC_EM01CTRL0_DRVSPEED_BEST_EFFICIENCY /**< Highest efficiency, highest EMI. Small increase in efficiency from INTERMEDIATE setting. */
