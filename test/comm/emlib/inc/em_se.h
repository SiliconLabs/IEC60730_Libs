...
#define SE_DATATRANSFER_DEFAULT(address, length)                               \
  {                                                                            \
      ...
      (length)                                                                 \
          | SE_DATATRANSFER_REALIGN /* Add size, use realign by default */     \
  }
...
SE_Response_t SE_initPubkey(uint32_t key_type,
                            void *pubkey,
                            uint32_t numBytes,
                            bool signature) SL_DEPRECATED_API_SDK_3_0;
...
SE_Response_t SE_writeUserData(uint32_t offset,
                               void *data,
                               uint32_t numBytes) SL_DEPRECATED_API_SDK_3_0;
...
// Debug commands
SE_Response_t
    SE_debugLockStatus(SE_DebugStatus_t *status) SL_DEPRECATED_API_SDK_3_0;
