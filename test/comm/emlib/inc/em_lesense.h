...
#define LESENSE_INIT_DEFAULT                                                         \
  {                                                                                  \
      .coreCtrl =                                                                    \
          LESENSE_CORECTRL_DESC_DEFAULT, /* Default core control parameters. */      \
      .timeCtrl =                                                                    \
          LESENSE_TIMECTRL_DESC_DEFAULT, /* Default time control parameters. */      \
      .perCtrl =                                                                     \
          LESENSE_PERCTRL_DESC_DEFAULT, /* Default peripheral control parameters. */ \
      .decCtrl =                                                                     \
          LESENSE_DECCTRL_DESC_DEFAULT /* Default decoder control parameters. */     \
  }
...
#define LESENSE_DECODER_CONF_DEFAULT                                           \
  { /* chain |   Descriptor A         |   Descriptor B   */                    \
    {                                                                          \
      ...
      {                                                                        \
        false, LESENSE_ST_CONF_DEFAULT, LESENSE_ST_CONF_DEFAULT                \
      } /* Decoder state 15. */                                                \
    }                                                                          \
  }
#elif defined(_SILICON_LABS_32B_SERIES_1)
