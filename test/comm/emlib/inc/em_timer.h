...
typedef enum {
  ...
  timerCCModeCompare =
      _TIMER_CC_CTRL_MODE_OUTPUTCOMPARE,   /**< Output compare. */
...
typedef enum {
  ...
  timerClkSelHFPerClk =
      _TIMER_CTRL_CLKSEL_PRESCHFPERCLK, /**< Prescaled HFPER / HFPERB clock. */
  timerClkSelCC1 =
      _TIMER_CTRL_CLKSEL_CC1, /**< Compare/Capture Channel 1 Input. */
  timerClkSelCascade =
      _TIMER_CTRL_CLKSEL_TIMEROUF /**< Cascaded clocked by underflow or overflow by lower numbered timer. */
#endif
#if defined(_TIMER_CFG_CLKSEL_MASK)
          timerClkSelHFPerClk =
              _TIMER_CFG_CLKSEL_PRESCEM01GRPACLK, /**< Prescaled EM01GRPA clock. */
  timerClkSelCC1 =
      _TIMER_CFG_CLKSEL_CC1, /**< Compare/Capture Channel 1 Input. */
  timerClkSelCascade =
      _TIMER_CFG_CLKSEL_TIMEROUF /**< Cascaded clocked by underflow or overflow by lower numbered timer. */
#endif
...
typedef enum {
  ...
  timerPrsInputSync =
      _TIMER_CC_CFG_INSEL_PRSSYNC, /**< Synchronous PRS selected. */
  timerPrsInputAsyncLevel =
      _TIMER_CC_CFG_INSEL_PRSASYNCLEVEL, /**< Asynchronous level PRS selected. */
  timerPrsInputAsyncPulse =
      _TIMER_CC_CFG_INSEL_PRSASYNCPULSE, /**< Asynchronous pulse PRS selected. */
...
typedef enum {
  ...
  timerDtiFaultActionInactive =
      _TIMER_DTFC_DTFA_INACTIVE, /**< Set outputs inactive. */
  timerDtiFaultActionClear = _TIMER_DTFC_DTFA_CLEAR, /**< Clear outputs. */
  timerDtiFaultActionTristate =
      _TIMER_DTFC_DTFA_TRISTATE /**< Tristate outputs. */
#endif
#if defined(_TIMER_DTFCFG_DTFA_MASK)
          timerDtiFaultActionNone =
              _TIMER_DTFCFG_DTFA_NONE, /**< No action on fault. */
  timerDtiFaultActionInactive =
      _TIMER_DTFCFG_DTFA_INACTIVE, /**< Set outputs inactive. */
  timerDtiFaultActionClear = _TIMER_DTFCFG_DTFA_CLEAR, /**< Clear outputs. */
  timerDtiFaultActionTristate =
      _TIMER_DTFCFG_DTFA_TRISTATE /**< Tristate outputs. */
#endif
...
typedef enum {
  ...
  timerPrsOutputDefault =
      timerPrsOutputPulse, /**< Default PRS output behavior. */
} TIMER_PrsOutput_t;
...
#define TIMER_INITDTI_DEFAULT                                                  \
  {                                                                            \
      ...
      TIMER_DTOGEN_DTOGCC0EN                                                   \
          | TIMER_DTOGEN_DTOGCDTI0EN, /* Enable CC0 and CDTI0. */              \
...
__STATIC_INLINE uint32_t TIMER_CaptureGet(TIMER_TypeDef *timer, unsigned int ch)
{
  ...
  if ((timer->CC[ch].CFG & _TIMER_CC_CFG_MODE_MASK)
      == TIMER_CC_CFG_MODE_INPUTCAPTURE) {
