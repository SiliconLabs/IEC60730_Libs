...
typedef enum {
  pdmCh3ClkPolarityRisingEdge =
      _PDM_CFG0_CH3CLKPOL_NORMAL, /**< Input data clocked on rising clock edge. */
  pdmCh3ClkPolarityFallingEdge =
      _PDM_CFG0_CH3CLKPOL_INVERT /**< Input data clocked on falling clock edge. */
} PDM_Ch3ClkPolarity_Typedef;

/** Configure CH2 CLK Polarity. */
typedef enum {
  pdmCh2ClkPolarityRisingEdge =
      _PDM_CFG0_CH2CLKPOL_NORMAL, /**< Input data clocked on rising clock edge. */
  pdmCh2ClkPolarityFallingEdge =
      _PDM_CFG0_CH2CLKPOL_INVERT /**< Input data clocked on falling clock edge. */
...
typedef enum {
  pdmCh1ClkPolarityRisingEdge =
      _PDM_CFG0_CH1CLKPOL_NORMAL, /**< Input data clocked on rising clock edge. */
  pdmCh1ClkPolarityFallingEdge =
      _PDM_CFG0_CH1CLKPOL_INVERT /**< Input data clocked on falling clock edge. */
} PDM_Ch1ClkPolarity_Typedef;

/** Configure CH0 CLK Polarity. */
typedef enum {
  pdmCh0ClkPolarityRisingEdge =
      _PDM_CFG0_CH0CLKPOL_NORMAL, /**< Input data clocked on rising clock edge. */
  pdmCh0ClkPolarityFallingEdge =
      _PDM_CFG0_CH0CLKPOL_INVERT /**< Input data clocked on falling clock edge. */
...
typedef enum {
  pdmDataFormatRight16 =
      _PDM_CFG0_DATAFORMAT_RIGHT16, /**< Right aligned 16-bit, left bits are sign extended. */
  pdmDataFormatDouble16 =
      _PDM_CFG0_DATAFORMAT_DOUBLE16, /**< Pack two 16-bit samples into one 32-bit word. */
  pdmDataFormatRight24 =
      _PDM_CFG0_DATAFORMAT_RIGHT24, /**< Right aligned 24bit, left bits are sign extended. */
  pdmDataFormatFull32bit = _PDM_CFG0_DATAFORMAT_FULL32BIT, /**< 32 bit data. */
  pdmDataFormatLeft16 =
      _PDM_CFG0_DATAFORMAT_LEFT16, /**< Left aligned 16-bit, right bits are zeros. */
  pdmDataFormatLeft24 =
      _PDM_CFG0_DATAFORMAT_LEFT24, /**< Left aligned 24-bit, right bits are zeros. */
  pdmDataFormatRaw32bit =
      _PDM_CFG0_DATAFORMAT_RAW32BIT /**< RAW 32 bit data from integrator. */
...
typedef struct {
...
#if defined(PDM_CFG0_NUMCH_THREE)
  bool
      enableCh2Ch3Stereo; /**< Enable stereo mode for channel pair CH2 and CH3. */
#endif
  bool
      enableCh0Ch1Stereo; /**< Enable stereo mode for channel pair CH0 and CH1. */
  PDM_FifoValidWatermark_Typedef
      fifoValidWatermark;            /**< FIFO Data valid level water-mark. */
  ...
  uint32_t
      prescaler; /**< PDM clock prescaler, resulting PDM clock is input clock / (prescaler + 1). */
} PDM_Init_TypeDef;
