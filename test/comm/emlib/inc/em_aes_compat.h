...
#define _AES_IF_CLR_FETCHERENDOFBLOCKIFC_SHIFT                                 \
  _AES_IF_CLR_FETCHERENDOFBLOCK_SHIFT
#define _AES_IF_CLR_FETCHERENDOFBLOCKIFC_MASK _AES_IF_CLR_FETCHERENDOFBLOCK_MASK
#define _AES_IF_CLR_FETCHERENDOFBLOCKIFC_DEFAULT                               \
  _AES_IF_CLR_FETCHERENDOFBLOCK_DEFAULT
#define AES_IF_CLR_FETCHERENDOFBLOCKIFC_DEFAULT                                \
  AES_IF_CLR_FETCHERENDOFBLOCK_DEFAULT
...
#define _AES_IF_CLR_PUSHERENDOFBLOCKIFC_DEFAULT                                \
  _AES_IF_CLR_PUSHERENDOFBLOCK_DEFAULT
#define AES_IF_CLR_PUSHERENDOFBLOCKIFC_DEFAULT                                 \
  AES_IF_CLR_PUSHERENDOFBLOCK_DEFAULT
