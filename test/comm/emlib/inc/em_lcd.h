...
typedef enum {
  ...
  lcdModeStepDown =
      LCD_DISPCTRL_MODE_STEPDOWN, /**< External cap with resistor string. */
  lcdModeCpIntOsc =
      LCD_DISPCTRL_MODE_CPINTOSC, /**< External cap and internal oscillator. */
#elif defined(_SILICON_LABS_32B_SERIES_2)
  lcdModeStepDown =
      LCD_BIASCTRL_MODE_STEPDOWN, /**< External cap with resistor string. */
  lcdModeChargePump =
      LCD_BIASCTRL_MODE_CHARGEPUMP, /**< External cap and internal oscillator. */
#endif
} LCD_Mode_Typedef;
#endif
...
typedef enum {
  lcdDmaModeDisable =
      LCD_BIASCTRL_DMAMODE_DMADISABLE, /**< No DMA requests are generated. */
  lcdDmaModeFrameCounterEvent =
      LCD_BIASCTRL_DMAMODE_DMAFC, /**< DMA request on frame counter event. */
  lcdDmaModeDisplayEvent =
      LCD_BIASCTRL_DMAMODE_DMADISPLAY /**< DMA request on display counter event. */
} LCD_DmaMode_Typedef;
#endif
...
{
  return (int) (LCD->STATUS & _LCD_STATUS_ASTATE_MASK)
         >> _LCD_STATUS_ASTATE_SHIFT;
}
...
{
  return (int) (LCD->STATUS & _LCD_STATUS_BLINK_MASK)
         >> _LCD_STATUS_BLINK_SHIFT;
}
 ...
 *   false.
 ******************************************************************************/
__STATIC_INLINE void LCD_SyncStart(bool autoload,
