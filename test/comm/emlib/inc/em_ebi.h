...
#define EBI_GENERIC_ALB_A0                                                     \
  EBI_ROUTE_ALB_A0 /**< Pin Enable Lower Bound EBI_A[0] and upwards */
#define EBI_GENERIC_ALB_A8                                                     \
  EBI_ROUTE_ALB_A8 /**< Pin Enable Lower Bound EBI_A[8] and upwards*/
#define EBI_GENERIC_ALB_A16                                                    \
  EBI_ROUTE_ALB_A16 /**< Pin Enable Lower Bound EBI_A[16] and upwards */
#define EBI_GENERIC_ALB_A24                                                    \
  EBI_ROUTE_ALB_A24 /**< Pin Enable Lower Bound EBI_A[24] and upwards */
...
#define EBI_GENERIC_ALB_A0                                                     \
  EBI_ROUTEPEN_ALB_A0 /**< Pin Enable Lower Bound EBI_A[0] and upwards */
#define EBI_GENERIC_ALB_A8                                                     \
  EBI_ROUTEPEN_ALB_A8 /**< Pin Enable Lower Bound EBI_A[8] and upwards*/
#define EBI_GENERIC_ALB_A16                                                    \
  EBI_ROUTEPEN_ALB_A16 /**< Pin Enable Lower Bound EBI_A[16] and upwards */
#define EBI_GENERIC_ALB_A24                                                    \
  EBI_ROUTEPEN_ALB_A24 /**< Pin Enable Lower Bound EBI_A[24] and upwards */
...
#define EBI_GENERIC_APEN_A10                                                   \
  EBI_ROUTEPEN_APEN_A10 /**< EBI_A[9:L] pins enabled */
#define EBI_GENERIC_APEN_A11                                                   \
  EBI_ROUTEPEN_APEN_A11 /**< EBI_A[10:L] pins enabled */
#define EBI_GENERIC_APEN_A12                                                   \
  EBI_ROUTEPEN_APEN_A12 /**< EBI_A[11:L] pins enabled */
#define EBI_GENERIC_APEN_A13                                                   \
  EBI_ROUTEPEN_APEN_A13 /**< EBI_A[12:L] pins enabled */
#define EBI_GENERIC_APEN_A14                                                   \
  EBI_ROUTEPEN_APEN_A14 /**< EBI_A[13:L] pins enabled */
#define EBI_GENERIC_APEN_A15                                                   \
  EBI_ROUTEPEN_APEN_A15 /**< EBI_A[14:L] pins enabled */
#define EBI_GENERIC_APEN_A16                                                   \
  EBI_ROUTEPEN_APEN_A16 /**< EBI_A[15:L] pins enabled */
#define EBI_GENERIC_APEN_A17                                                   \
  EBI_ROUTEPEN_APEN_A17 /**< EBI_A[16:L] pins enabled */
#define EBI_GENERIC_APEN_A18                                                   \
  EBI_ROUTEPEN_APEN_A18 /**< EBI_A[17:L] pins enabled */
#define EBI_GENERIC_APEN_A19                                                   \
  EBI_ROUTEPEN_APEN_A19 /**< EBI_A[18:L] pins enabled */
#define EBI_GENERIC_APEN_A20                                                   \
  EBI_ROUTEPEN_APEN_A20 /**< EBI_A[19:L] pins enabled */
#define EBI_GENERIC_APEN_A21                                                   \
  EBI_ROUTEPEN_APEN_A21 /**< EBI_A[20:L] pins enabled */
#define EBI_GENERIC_APEN_A22                                                   \
  EBI_ROUTEPEN_APEN_A22 /**< EBI_A[21:L] pins enabled */
#define EBI_GENERIC_APEN_A23                                                   \
  EBI_ROUTEPEN_APEN_A23 /**< EBI_A[22:L] pins enabled */
#define EBI_GENERIC_APEN_A24                                                   \
  EBI_ROUTEPEN_APEN_A24 /**< EBI_A[23:L] pins enabled */
#define EBI_GENERIC_APEN_A25                                                   \
  EBI_ROUTEPEN_APEN_A25 /**< EBI_A[24:L] pins enabled */
#define EBI_GENERIC_APEN_A26                                                   \
  EBI_ROUTEPEN_APEN_A26 /**< EBI_A[25:L] pins enabled */
#define EBI_GENERIC_APEN_A27                                                   \
  EBI_ROUTEPEN_APEN_A27 /**< EBI_A[26:L] pins enabled */
#define EBI_GENERIC_APEN_A28                                                   \
  EBI_ROUTEPEN_APEN_A28 /**< EBI_A[27:L] pins enabled */
#endif
...
void EBI_BankReadTimingSet(uint32_t bank,
                           uint32_t setupCycles,
                           uint32_t strobeCycles,
                           uint32_t holdCycles);
void EBI_BankReadTimingConfig(uint32_t bank,
                              bool pageMode,
                              bool prefetch,
                              bool halfRE);

void EBI_BankWriteTimingSet(uint32_t bank,
                            uint32_t setupCycles,
                            uint32_t strobeCycles,
                            uint32_t holdCycles);
void EBI_BankWriteTimingConfig(uint32_t bank,
                               bool writeBufDisable,
                               bool halfWE);

void EBI_BankAddressTimingSet(uint32_t bank,
                              uint32_t setupCycles,
                              uint32_t holdCycles);
void EBI_BankAddressTimingConfig(uint32_t bank, bool halfALE);

void EBI_BankPolaritySet(uint32_t bank,
...
{
  return ((EBI->TFTSTATUS & _EBI_TFTSTATUS_VCNT_MASK)
          >> _EBI_TFTSTATUS_VCNT_SHIFT);
}
...
{
  return ((EBI->TFTSTATUS & _EBI_TFTSTATUS_HCNT_MASK)
          >> _EBI_TFTSTATUS_HCNT_SHIFT);
}
