...
typedef enum {
  ...
  adcSingleInputTemp =
      _ADC_SINGLECTRL_INPUTSEL_TEMP, /**< Temperature reference. */
  adcSingleInputVDDDiv3 =
      _ADC_SINGLECTRL_INPUTSEL_VDDDIV3,             /**< VDD divided by 3. */
  ...
  adcSingleInputVrefDiv2 =
      _ADC_SINGLECTRL_INPUTSEL_VREFDIV2, /**< Vref divided by 2. */
  adcSingleInputDACOut0 =
      _ADC_SINGLECTRL_INPUTSEL_DAC0OUT0, /**< DAC output 0. */
  adcSingleInputDACOut1 =
      _ADC_SINGLECTRL_INPUTSEL_DAC0OUT1, /**< DAC output 1. */
  adcSingleInputATEST = 15,              /**< ATEST. */

  /* Differential mode enabled */
  adcSingleInputCh0Ch1 =
      _ADC_SINGLECTRL_INPUTSEL_CH0CH1, /**< Positive Ch0, negative Ch1. */
  adcSingleInputCh2Ch3 =
      _ADC_SINGLECTRL_INPUTSEL_CH2CH3, /**< Positive Ch2, negative Ch3. */
  adcSingleInputCh4Ch5 =
      _ADC_SINGLECTRL_INPUTSEL_CH4CH5, /**< Positive Ch4, negative Ch5. */
  adcSingleInputCh6Ch7 =
      _ADC_SINGLECTRL_INPUTSEL_CH6CH7, /**< Positive Ch6, negative Ch7. */
...
#define ADC_SCANINPUTSEL_NONE                                                  \
  ((ADC_SCANINPUTSEL_GROUP_NONE << _ADC_SCANINPUTSEL_INPUT0TO7SEL_SHIFT)       \
   | (ADC_SCANINPUTSEL_GROUP_NONE << _ADC_SCANINPUTSEL_INPUT8TO15SEL_SHIFT)    \
   | (ADC_SCANINPUTSEL_GROUP_NONE << _ADC_SCANINPUTSEL_INPUT16TO23SEL_SHIFT)   \
   | (ADC_SCANINPUTSEL_GROUP_NONE << _ADC_SCANINPUTSEL_INPUT24TO31SEL_SHIFT))
...
#elif (!defined(_ADC_CTRL_LPFMODE_MASK))                                       \
    && (!defined(_ADC_CTRL_ADCCLKMODE_MASK))
#define ADC_INIT_DEFAULT                                                       \
  {                                                                            \
      adcOvsRateSel2,             /* 2x oversampling (if enabled). */          \
      adcWarmupNormal,            /* ADC shutdown after each conversion. */    \
