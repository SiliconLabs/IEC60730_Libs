...
sl_iec60730_test_result_t sl_iec60730_cpu_registers_bist(void)
{
  ...
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_core()) {
  ...
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_bist_ns()) {
    goto CPU_REGISTERS_BIST_DONE;
  }
  /* Test cpu register secure */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_bist_s()) {
    goto CPU_REGISTERS_BIST_DONE;
  }
...
#error the CM33 without TZ is not supported
  ...
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_msp()) {
    goto CPU_REGISTERS_BIST_DONE;
  }

  /* Test Process Stack Pointer */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_psp()) {
    goto CPU_REGISTERS_BIST_DONE;
  }

  /* Test Control register */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_control()) {
    goto CPU_REGISTERS_BIST_DONE;
  }

  /* Test Primask register */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_primask()) {
    goto CPU_REGISTERS_BIST_DONE;
  }

  /* Test BasePri register */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_basepri()) {
    goto CPU_REGISTERS_BIST_DONE;
  }

  /* Test FaultMask register */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_faultmask()) {
    goto CPU_REGISTERS_BIST_DONE;
  }
#endif

  /* Test FPU FPSCR register */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_fpu_fpscr()) {
    goto CPU_REGISTERS_BIST_DONE;
  }
