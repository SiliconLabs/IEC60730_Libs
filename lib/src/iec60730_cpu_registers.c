 ...
 *****************************************************************************/
sl_iec60730_test_result_t iec60730_CpuRegistersBist(void)
{
  /* Test core register: APSR, R0-R12, LR */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersCore())
  ...
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersMSP_NS())
    return IEC60730_TEST_FAILED;

  /* Test Main Stack Pointer Secure */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersMSP_S())
    return IEC60730_TEST_FAILED;

  /* Test Process Stack Pointer Non Secure */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersPSP_NS())
    return IEC60730_TEST_FAILED;

  /* Test Process Stack Pointer Secure */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersPSP_S())
    return IEC60730_TEST_FAILED;

  /* Test Main Stack Pointer Limit Non Secure */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersMSPLim_NS())
    return IEC60730_TEST_FAILED;

  /* Test Main Stack Pointer Limit Secure */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersMSPLim_S())
    return IEC60730_TEST_FAILED;

  /* Test Process Stack Pointer Limit None Secure */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersPSPLim_NS())
    return IEC60730_TEST_FAILED;

  /* Test Process Stack Pointer Limit Secure */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersPSPLim_S())
    return IEC60730_TEST_FAILED;

  /* Test Control None Secure register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersControl_NS())
    return IEC60730_TEST_FAILED;

  /* Test Control Secure register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersControl_S())
    return IEC60730_TEST_FAILED;

  /* Test Primask Non Secure register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersPriMask_NS())
    return IEC60730_TEST_FAILED;

  /* Test Primask Secure register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersPriMask_S())
    return IEC60730_TEST_FAILED;

  /* Test BasePri Non Secure register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersBasePri_NS())
    return IEC60730_TEST_FAILED;

  /* Test BasePri Secure register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersBasePri_S())
    return IEC60730_TEST_FAILED;

  /* Test FaultMask Non Secure register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersFaultMask_NS())
    return IEC60730_TEST_FAILED;

  /* Test FaultMask Secure register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersFaultMask_S())
    return IEC60730_TEST_FAILED;
#endif
#else
#error the CM33 without TZ is not supported
  ...
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersMSP())
    return IEC60730_TEST_FAILED;

  /* Test Process Stack Pointer */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersPSP())
    return IEC60730_TEST_FAILED;

  /* Test Control register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersControl())
    return IEC60730_TEST_FAILED;

  /* Test Primask register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersPriMask())
    return IEC60730_TEST_FAILED;

  /* Test BasePri register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersBasePri())
    return IEC60730_TEST_FAILED;

  /* Test FaultMask register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersFaultMask())
    return IEC60730_TEST_FAILED;
#endif

  /* Test FPU FPSCR register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersFPU_FPSCR())
    return IEC60730_TEST_FAILED;

  /* Test FPU So-S31 register */
  if (IEC60730_TEST_FAILED == iec60730_CpuRegistersFPU_FPSx())
    return IEC60730_TEST_FAILED;
 ...
 *****************************************************************************/
sl_iec60730_test_result_t iec60730_CpuRegistersPost(void)
{
 ...
 *****************************************************************************/
sl_iec60730_test_result_t iec60730_CpuRegistersCore(void)
{
  sl_iec60730_test_result_t result;
...
sl_iec60730_test_result_t iec60730_CpuRegistersMSP_NS(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersMSP_S(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
#if (IEC60370_CPU == IEC60370_CM4)
sl_iec60730_test_result_t iec60730_CpuRegistersMSP(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersPSP_NS(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersPSP_S(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
#if (IEC60370_CPU == IEC60370_CM4)
sl_iec60730_test_result_t iec60730_CpuRegistersPSP(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersMSPLim_NS(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersMSPLim_S(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersPSPLim_NS(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersPSPLim_S(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersControl_NS(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersControl_S(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
#if (IEC60370_CPU == IEC60370_CM4)
sl_iec60730_test_result_t iec60730_CpuRegistersControl(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersPriMask_NS(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersPriMask_S(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
#if (IEC60370_CPU == IEC60370_CM4)
sl_iec60730_test_result_t iec60730_CpuRegistersPriMask(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersBasePri_NS(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersBasePri_S(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
#if (IEC60370_CPU == IEC60370_CM4)
sl_iec60730_test_result_t iec60730_CpuRegistersBasePri(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersFaultMask_NS(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
     ...
     && (__TZ_PRESENT == 1))                                                   \
    && defined(__ARM_FEATURE_CMSE) && (__ARM_FEATURE_CMSE == 3U)
sl_iec60730_test_result_t iec60730_CpuRegistersFaultMask_S(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
#if (IEC60370_CPU == IEC60370_CM4)
sl_iec60730_test_result_t iec60730_CpuRegistersFaultMask(void)
{
  sl_iec60730_test_result_t result;
 ...
 *****************************************************************************/
sl_iec60730_test_result_t iec60730_CpuRegistersFPU_FPSCR(void)
{
 ...
 * Floating Point Unit (FPU).
 *****************************************************************************/
sl_iec60730_test_result_t iec60730_CpuRegistersFPU_FPSx(void)
{
  sl_iec60730_test_result_t result = IEC60730_TEST_PASSED;
#if (IEC60370_CPU == IEC60370_CM4)                                             \
