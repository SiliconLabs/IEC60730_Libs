...
#if (defined(SL_IEC60730_IRQ_STATUS_EN) && (SL_IEC60730_IRQ_STATUS_EN == 1))
static sl_iec60730_irq_fail_t iec60730_irq_fail_result = {0,0};
#endif //(defined(SL_IEC60730_IRQ_STATUS_EN) && (SL_IEC60730_IRQ_STATUS_EN == 1))
...
void sl_iec60730_irq_init(sl_iec60730_irq_cfg_t * irq_cfg_ptr)
{
  if(irq_cfg_ptr != NULL) {
    if(irq_cfg_ptr->size < IEC60730_MAX_IRQ_CHECK) {
      ...
      iec60730_SafeState(IEC60730_INTERRUPT_FAIL);
    }
  }
}
