...
sl_iec60730_test_result_t sl_iec60730_cpu_registers_bist_s(void)
{
  ...
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_msp_s()) {
    goto CPU_REGISTERS_BIST_S_DONE;
  }

  /* Test Process Stack Pointer Secure */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_psp_s()) {
    goto CPU_REGISTERS_BIST_S_DONE;
  }

  /* Test Main Stack Pointer Limit Secure */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_msplim_s()) {
    goto CPU_REGISTERS_BIST_S_DONE;
  }

  /* Test Process Stack Pointer Limit Secure */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_psplim_s()) {
    goto CPU_REGISTERS_BIST_S_DONE;
  }

  /* Test Control Secure register */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_control_s()) {
    goto CPU_REGISTERS_BIST_S_DONE;
  }

  /* Test Primask Secure register */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_primask_s()) {
    goto CPU_REGISTERS_BIST_S_DONE;
  }

  /* Test BasePri Secure register */
  if (IEC60730_TEST_FAILED == sl_iec60730_cpu_registers_basepri_s()) {
    goto CPU_REGISTERS_BIST_S_DONE;
  }
