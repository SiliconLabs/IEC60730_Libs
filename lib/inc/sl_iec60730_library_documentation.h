 ...
 *
 * @note The IEC 60730 library support extension for GSDK using
 ...
 * \link sl_iec60730_post POST component\endlink is run immediately after
 * power on, validating system state before entering the main
 * execution loop.
 *
 * The \link sl_iec60730_bist BIST component\endlink is run periodically in the
 * main execution loop.
 *
 ...
 *
 * oem_iec60730_functions.c includes functions and variables that OEMs must
 ...
 * OEMs must customize the sl_iec60730_safe_state() function according to their
 ...
 * #iec60730_IRQExecCount; for an example, see oem_iec60730_timer.c. OEMs
 ...
 * appropriate. It is not run as part of sl_iec60730_bist().
 *
 ...
 * OEMs must manually add this check to their main system loop where
 * appropriate. It is not run as part of sl_iec60730_bist(). For more details
 ...
 * sl_iec60730_bist() to guarantee all the invariable memory areas are checked
