/***************************************************************************//**
 * @file
 * @brief CMSIS Compatible EFR32MG21 none secure startup file in C.
...
void RTCC_IRQHandler(void) __attribute__ ((weak, alias("Default_Handler_NS")));
...
void USART1_RX_IRQHandler(void) __attribute__ ((weak, alias("Default_Handler_NS")));
void USART1_TX_IRQHandler(void) __attribute__ ((weak, alias("Default_Handler_NS")));
void USART2_RX_IRQHandler(void) __attribute__ ((weak, alias("Default_Handler_NS")));
void USART2_TX_IRQHandler(void) __attribute__ ((weak, alias("Default_Handler_NS")));
...
void EMUSE_IRQHandler(void) __attribute__ ((weak, alias("Default_Handler_NS")));
...
void PRORTC_IRQHandler(void) __attribute__ ((weak, alias("Default_Handler_NS")));
...
void HFXO00_IRQHandler(void) __attribute__ ((weak, alias("Default_Handler_NS")));
